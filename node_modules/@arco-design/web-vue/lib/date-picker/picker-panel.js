...
const _sfc_main = vue.defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const hasShortcuts = vue.computed(() => shortcuts2.value && shortcuts2.value.length);
    const showShortcutsNowBtn = vue.computed(() => showConfirmBtn.value && showNowBtn.value && !hasShortcuts.value);
    ...
    vue.createElementVNode("div", {
      ...
      vue.createVNode(_component_PanelFooter, {
        ...
        _ctx.extra ? {
          name: "extra",
          fn: vue.withCtx(() => [
            vue.createVNode(_component_RenderFunction, { "render-func": _ctx.extra }, null, 8, ["render-func"])
          ])
        } : void 0,
