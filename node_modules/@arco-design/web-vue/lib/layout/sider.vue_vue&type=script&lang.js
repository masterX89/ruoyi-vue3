...
var _sfc_main = vue.defineComponent({
  ...
  setup(props, {
    ...
    const responsiveObserveToken = vue.ref("");
    vue.onMounted(() => {
      responsiveObserveToken.value = responsiveObserve["default"].subscribe((screens, breakpointChecked) => {
    ...
    vue.onUnmounted(() => {
      responsiveObserve["default"].unsubscribe(responsiveObserveToken.value);
    });
