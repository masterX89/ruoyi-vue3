...
const getArrowStyle = (position, triggerRect, popupRect, {
  ...
  switch (position) {
    ...
    case "tl": {
      ...
      return __spreadValues({
        left: `${Math.round(halfWidth < popupRect.width ? halfWidth : popupRect.width / 2)}px`,
        bottom: "0",
        transform: withRotate("translate(-50%,50%)")
      }, customStyle);
    }
    case "tr": {
      const halfWidth = triggerRect.width / 2;
      return __spreadValues({
        right: `${Math.round(halfWidth < popupRect.width ? halfWidth : popupRect.width / 2)}px`,
        bottom: "0",
        transform: withRotate("translate(50%,50%)")
      }, customStyle);
    }
    ...
    case "lt": {
      ...
      return __spreadValues({
        right: "0",
        top: `${Math.round(halfHeight < popupRect.height ? halfHeight : popupRect.height / 2)}px`,
        transform: withRotate("translate(50%,-50%)")
      }, customStyle);
    }
    case "lb": {
      ...
      return __spreadValues({
        right: "0",
        bottom: `${Math.round(halfHeight < popupRect.height ? halfHeight : popupRect.height / 2)}px`,
        transform: withRotate("translate(50%,50%)")
      }, customStyle);
    }
    case "right":
