...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock("span", {
    ...
    !_ctx.simple ? (vue.openBlock(), vue.createElementBlock("span", {
      key: 0,
      class: vue.normalizeClass(`${_ctx.prefixCls}-text-goto`)
    }, vue.toDisplayString(_ctx.t("pagination.goto")), 3)) : vue.createCommentVNode("v-if", true),
    ...
    _ctx.simple ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 1 }, [
