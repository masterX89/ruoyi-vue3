...
import BaseGridItem from "./base-grid-item.js";
import { getGridItemChildren, resolveItemData, setItemVisible } from "./utils/index.js";
function _isSlot(s) {
...
const Grid = (props, {
  ...
  const itemData = itemList.map((node) => __spreadProps(__spreadValues({}, resolveItemData(cols, node.props || {})), {
    node
  }));
  const {
    overflow,
  ...
  return createVNode(BaseGrid, mergeProps(props, {
    "cols": cols,
    ...
    return createVNode(__spreadProps(__spreadValues({}, BaseGridItem), {
      __scopeId: scopeId
