...
export declare const contains: (root: Node, ele: Node) => boolean;
...
export declare const getElement: (target: string | HTMLElement, container?: HTMLElement | Document | undefined) => HTMLElement | undefined;
