...
!function(e, t) {
  ...
  } }), Be = e.defineComponent({ name: "IconDown", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-down`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Ce = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Ne = [e.createElementVNode("path", { d: "M39.6 17.443 24.043 33 8.487 17.443" }, null, -1)];
  var $e = r(Be, [["render", function(t2, n2, o2, i2, r2, s2) {
    return e.openBlock(), e.createElementBlock("svg", { viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg", stroke: "currentColor", class: e.normalizeClass(t2.cls), style: e.normalizeStyle(t2.sizeStyle), "stroke-width": t2.strokeWidth, "stroke-linecap": t2.strokeLinecap, "stroke-linejoin": t2.strokeLinejoin }, Ne, 14, Ce);
  }]]);
  ...
  var Et = r(Ct, [["render", function(t2, n2, o2, i2, r2, s2) {
  ...
  } }), xn = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Bn = [e.createElementVNode("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M24 44c11.046 0 20-8.954 20-20S35.046 4 24 4 4 12.954 4 24s8.954 20 20 20Zm-2-11a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1v-2a1 1 0 0 0-1-1h-2a1 1 0 0 0-1 1v2Zm4-18a1 1 0 0 0-1-1h-2a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1V15Z", fill: "currentColor", stroke: "none" }, null, -1)];
  var Cn = r(Ln, [["render", function(t2, n2, o2, i2, r2, s2) {
    return e.openBlock(), e.createElementBlock("svg", { viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg", stroke: "currentColor", class: e.normalizeClass(t2.cls), style: e.normalizeStyle(t2.sizeStyle), "stroke-width": t2.strokeWidth, "stroke-linecap": t2.strokeLinecap, "stroke-linejoin": t2.strokeLinejoin }, Bn, 14, xn);
  }]]);
  const Nn = Object.assign(Cn, { install: (e2, t2) => {
    var _a2;
    const n2 = (_a2 = t2 == null ? void 0 : t2.iconPrefix) != null ? _a2 : "";
    e2.component(n2 + Cn.name, Cn);
  ...
  } }), Bo = e.defineComponent({ name: "IconClose", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-close`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Co = ["stroke-width", "stroke-linecap", "stroke-linejoin"], No = [e.createElementVNode("path", { d: "M9.857 9.858 24 24m0 0 14.142 14.142M24 24 38.142 9.858M24 24 9.857 38.142" }, null, -1)];
  var $o = r(Bo, [["render", function(t2, n2, o2, i2, r2, s2) {
    return e.openBlock(), e.createElementBlock("svg", { viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg", stroke: "currentColor", class: e.normalizeClass(t2.cls), style: e.normalizeStyle(t2.sizeStyle), "stroke-width": t2.strokeWidth, "stroke-linecap": t2.strokeLinecap, "stroke-linejoin": t2.strokeLinejoin }, No, 14, Co);
  }]]);
  ...
  } }), Ci = e.defineComponent({ name: "IconStop", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
  ...
  var Ei = r(Ci, [["render", function(t2, n2, o2, i2, r2, s2) {
  ...
  var Br = r(jr, [["render", function(t2, n2, o2, i2, r2, s2) {
  ...
  const Cr = Object.assign(Br, { install: (e2, t2) => {
    var _a2;
    const n2 = (_a2 = t2 == null ? void 0 : t2.iconPrefix) != null ? _a2 : "";
    e2.component(n2 + Br.name, Br);
  ...
  } }), fs = ["stroke-width", "stroke-linecap", "stroke-linejoin"], vs = [e.createElementVNode("path", { d: "M13 24h30M5 12h4m4 24h30M13 12h30M5 24h4M5 36h4" }, null, -1)];
  var hs = r(zs, [["render", function(t2, n2, o2, i2, r2, s2) {
    return e.openBlock(), e.createElementBlock("svg", { viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg", stroke: "currentColor", class: e.normalizeClass(t2.cls), style: e.normalizeStyle(t2.sizeStyle), "stroke-width": t2.strokeWidth, "stroke-linecap": t2.strokeLinecap, "stroke-linejoin": t2.strokeLinejoin }, vs, 14, fs);
  }]]);
  const ys = Object.assign(hs, { install: (e2, t2) => {
    var _a2;
    const n2 = (_a2 = t2 == null ? void 0 : t2.iconPrefix) != null ? _a2 : "";
    e2.component(n2 + hs.name, hs);
  } }), gs = e.defineComponent({ name: "IconMessageBanned", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-message-banned`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Ss = ["stroke-width", "stroke-linecap", "stroke-linejoin"], ws = [e.createElementVNode("path", { d: "M40.527 20C38.727 12.541 32.01 7 24 7 14.611 7 7 14.611 7 24v17h14m19.364-.636a9 9 0 0 0-12.728-12.728m12.728 12.728a9 9 0 0 1-12.728-12.728m12.728 12.728L27.636 27.636M13 20h12m-12 9h6" }, null, -1)];
  ...
  } }), Ls = e.defineComponent({ name: "IconMessage", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-message`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), xs = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Bs = [e.createElementVNode("path", { d: "M15 20h18m-18 9h9M7 41h17.63C33.67 41 41 33.67 41 24.63V24c0-9.389-7.611-17-17-17S7 14.611 7 24v17Z" }, null, -1)];
  var Cs = r(Ls, [["render", function(t2, n2, o2, i2, r2, s2) {
    return e.openBlock(), e.createElementBlock("svg", { viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg", stroke: "currentColor", class: e.normalizeClass(t2.cls), style: e.normalizeStyle(t2.sizeStyle), "stroke-width": t2.strokeWidth, "stroke-linecap": t2.strokeLinecap, "stroke-linejoin": t2.strokeLinejoin }, Bs, 14, xs);
  }]]);
  const Ns = Object.assign(Cs, { install: (e2, t2) => {
    var _a2;
    const n2 = (_a2 = t2 == null ? void 0 : t2.iconPrefix) != null ? _a2 : "";
    e2.component(n2 + Cs.name, Cs);
  } }), $s = e.defineComponent({ name: "IconMoreVertical", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-more-vertical`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Es = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Ms = [e.createElementVNode("path", { d: "M25 10h-2V8h2v2ZM25 25h-2v-2h2v2ZM25 40h-2v-2h2v2Z", fill: "currentColor", stroke: "none" }, null, -1), e.createElementVNode("path", { d: "M25 10h-2V8h2v2ZM25 25h-2v-2h2v2ZM25 40h-2v-2h2v2Z" }, null, -1)];
  ...
  } }), Ws = e.defineComponent({ name: "IconMore", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-more`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Zs = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Ps = [e.createElementVNode("path", { d: "M38 25v-2h2v2h-2ZM23 25v-2h2v2h-2ZM8 25v-2h2v2H8Z", fill: "currentColor", stroke: "none" }, null, -1), e.createElementVNode("path", { d: "M38 25v-2h2v2h-2ZM23 25v-2h2v2h-2ZM8 25v-2h2v2H8Z" }, null, -1)];
  ...
  } }), Hs = e.defineComponent({ name: "IconPoweroff", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-poweroff`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Fs = ["stroke-width", "stroke-linecap", "stroke-linejoin"], As = [e.createElementVNode("path", { d: "M15.5 9.274C10.419 12.214 7 17.708 7 24c0 9.389 7.611 17 17 17s17-7.611 17-17c0-6.292-3.419-11.786-8.5-14.726M24 5v22" }, null, -1)];
  ...
  } }), Ts = e.defineComponent({ name: "IconRefresh", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-refresh`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Us = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Qs = [e.createElementVNode("path", { d: "M38.837 18C36.463 12.136 30.715 8 24 8 15.163 8 8 15.163 8 24s7.163 16 16 16c7.455 0 13.72-5.1 15.496-12M40 8v10H30" }, null, -1)];
  ...
  } }), Js = e.defineComponent({ name: "IconReply", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-reply`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Ks = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Ys = [e.createElementVNode("path", { d: "m6.642 24.684 14.012 14.947a.2.2 0 0 0 .346-.137v-8.949A23.077 23.077 0 0 1 26 30c6.208 0 11.84 2.459 15.978 6.456a.01.01 0 0 0 .017-.007C42 36.299 42 36.15 42 36c0-10.493-8.506-19-19-19-.675 0-1.342.035-2 .104V8.506a.2.2 0 0 0-.346-.137L6.642 23.316a1 1 0 0 0 0 1.368Z" }, null, -1)];
  ...
  } }), tl = e.defineComponent({ name: "IconSave", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-save`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), nl = ["stroke-width", "stroke-linecap", "stroke-linejoin"], ol = [e.createElementVNode("path", { d: "M21 13v9m18 20H9a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1h22.55a1 1 0 0 1 .748.336l7.45 8.38a1 1 0 0 1 .252.664V41a1 1 0 0 1-1 1ZM14 6h14v15a1 1 0 0 1-1 1H15a1 1 0 0 1-1-1V6Z" }, null, -1)];
  ...
  } }), sl = e.defineComponent({ name: "IconScan", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-scan`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), ll = ["stroke-width", "stroke-linecap", "stroke-linejoin"], cl = [e.createElementVNode("path", { d: "M7 17V7h10m24 10V7H31m10 24v10H31M7 31v10h10M5 24h38" }, null, -1)];
  ...
  } }), ul = e.defineComponent({ name: "IconSearch", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-search`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), dl = ["stroke-width", "stroke-linecap", "stroke-linejoin"], ml = [e.createElementVNode("path", { d: "M33.072 33.071c6.248-6.248 6.248-16.379 0-22.627-6.249-6.249-16.38-6.249-22.628 0-6.248 6.248-6.248 16.379 0 22.627 6.248 6.248 16.38 6.248 22.628 0Zm0 0 8.485 8.485" }, null, -1)];
  ...
  } }), fl = e.defineComponent({ name: "IconSelectAll", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
  ...
  } }), Sl = e.defineComponent({ name: "IconSend", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-send`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), wl = ["stroke-width", "stroke-linecap", "stroke-linejoin"], bl = [e.createElementVNode("path", { d: "m14 24-7-5V7l34 17L7 41V29l7-5Zm0 0h25", "stroke-miterlimit": "3.864" }, null, -1)];
  ...
  } }), xl = e.defineComponent({ name: "IconSettings", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-settings`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Bl = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Cl = [e.createElementVNode("path", { d: "M18.797 6.732A1 1 0 0 1 19.76 6h8.48a1 1 0 0 1 .964.732l1.285 4.628a1 1 0 0 0 1.213.7l4.651-1.2a1 1 0 0 1 1.116.468l4.24 7.344a1 1 0 0 1-.153 1.2L38.193 23.3a1 1 0 0 0 0 1.402l3.364 3.427a1 1 0 0 1 .153 1.2l-4.24 7.344a1 1 0 0 1-1.116.468l-4.65-1.2a1 1 0 0 0-1.214.7l-1.285 4.628a1 1 0 0 1-.964.732h-8.48a1 1 0 0 1-.963-.732L17.51 36.64a1 1 0 0 0-1.213-.7l-4.65 1.2a1 1 0 0 1-1.116-.468l-4.24-7.344a1 1 0 0 1 .153-1.2L9.809 24.7a1 1 0 0 0 0-1.402l-3.364-3.427a1 1 0 0 1-.153-1.2l4.24-7.344a1 1 0 0 1 1.116-.468l4.65 1.2a1 1 0 0 0 1.213-.7l1.286-4.628Z" }, null, -1), e.createElementVNode("path", { d: "M30 24a6 6 0 1 1-12 0 6 6 0 0 1 12 0Z" }, null, -1)];
  var Nl = r(xl, [["render", function(t2, n2, o2, i2, r2, s2) {
    return e.openBlock(), e.createElementBlock("svg", { viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg", stroke: "currentColor", class: e.normalizeClass(t2.cls), style: e.normalizeStyle(t2.sizeStyle), "stroke-width": t2.strokeWidth, "stroke-linecap": t2.strokeLinecap, "stroke-linejoin": t2.strokeLinejoin }, Cl, 14, Bl);
  }]]);
  const $l = Object.assign(Nl, { install: (e2, t2) => {
    var _a2;
    const n2 = (_a2 = t2 == null ? void 0 : t2.iconPrefix) != null ? _a2 : "";
    e2.component(n2 + Nl.name, Nl);
  } }), El = e.defineComponent({ name: "IconShareAlt", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-share-alt`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Ml = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Vl = [e.createElementVNode("path", { d: "M32.442 21.552a4.5 4.5 0 1 1 .065 4.025m-.065-4.025-16.884-8.104m16.884 8.104A4.483 4.483 0 0 0 32 23.5c0 .75.183 1.455.507 2.077m-16.95-12.13a4.5 4.5 0 1 1-8.113-3.895 4.5 4.5 0 0 1 8.114 3.896Zm-.064 20.977A4.5 4.5 0 1 0 11.5 41c3.334-.001 5.503-3.68 3.993-6.578Zm0 0 17.014-8.847" }, null, -1)];
  ...
  const Wl = Object.assign(Il, { install: (e2, t2) => {
    ...
    const n2 = (_a2 = t2 == null ? void 0 : t2.iconPrefix) != null ? _a2 : "";
    e2.component(n2 + Il.name, Il);
  } }), Zl = e.defineComponent({ name: "IconShareExternal", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-share-external`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Pl = ["stroke-width", "stroke-linecap", "stroke-linejoin"], ql = [e.createElementVNode("path", { d: "M18 20h-7a1 1 0 0 0-1 1v20a1 1 0 0 0 1 1h26a1 1 0 0 0 1-1V21a1 1 0 0 0-1-1h-7m2.368-5.636L24.004 6l-8.364 8.364M24.003 28V6.604", "stroke-miterlimit": "16" }, null, -1)];
  ...
  } }), Fl = e.defineComponent({ name: "IconShareInternal", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-share-internal`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Al = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Dl = [e.createElementVNode("path", { d: "M40 35v6H8v-6m1.108-4c1.29-8.868 13.917-15.85 29.392-15.998M30 6l9 9-9 9" }, null, -1)];
  ...
  } }), Ul = e.defineComponent({ name: "IconStar", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-star`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Ql = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Gl = [e.createElementVNode("path", { d: "M22.552 6.908a.5.5 0 0 1 .896 0l5.02 10.17a.5.5 0 0 0 .376.274l11.224 1.631a.5.5 0 0 1 .277.853l-8.122 7.916a.5.5 0 0 0-.143.443l1.917 11.178a.5.5 0 0 1-.726.527l-10.038-5.278a.5.5 0 0 0-.466 0L12.73 39.9a.5.5 0 0 1-.726-.527l1.918-11.178a.5.5 0 0 0-.144-.443l-8.122-7.916a.5.5 0 0 1 .278-.853l11.223-1.63a.5.5 0 0 0 .376-.274l5.02-10.17Z" }, null, -1)];
  ...
  } }), nc = e.defineComponent({ name: "IconThumbDown", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-thumb-down`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), oc = ["stroke-width", "stroke-linecap", "stroke-linejoin"], ic = [e.createElementVNode("path", { d: "M41 31V5M5.83 26.394l5.949-18.697A1 1 0 0 1 12.732 7H34v22h-3l-9.403 12.223a1 1 0 0 1-1.386.196l-2.536-1.87a6 6 0 0 1-2.043-6.974L17 29H7.736a2 2 0 0 1-1.906-2.606Z" }, null, -1)];
  ...
  } }), lc = e.defineComponent({ name: "IconThumbUp", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-thumb-up`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), cc = ["stroke-width", "stroke-linecap", "stroke-linejoin"], ac = [e.createElementVNode("path", { d: "M7 17v26m35.17-21.394-5.948 18.697a1 1 0 0 1-.953.697H14V19h3l9.403-12.223a1 1 0 0 1 1.386-.196l2.535 1.87a6 6 0 0 1 2.044 6.974L31 19h9.265a2 2 0 0 1 1.906 2.606Z" }, null, -1)];
  ...
  } }), dc = e.defineComponent({ name: "IconTranslate", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-translate`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), mc = ["stroke-width", "stroke-linecap", "stroke-linejoin"], kc = [e.createElementVNode("path", { d: "M42 25c0 9.941-8.059 18-18 18-6.867 0-12.836-3.845-15.87-9.5M28.374 27 25 18h-2l-3.375 9m8.75 0L31 34m-2.625-7h-8.75m0 0L17 34M6 25c0-9.941 8.059-18 18-18 6.867 0 12.836 3.845 15.87 9.5M43 25h-2l1-1 1 1ZM5 25h2l-1 1-1-1Z" }, null, -1)];
  ...
  } }), vc = e.defineComponent({ name: "IconUpload", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-upload`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), hc = ["stroke-width", "stroke-linecap", "stroke-linejoin"], yc = [e.createElementVNode("path", { d: "M14.93 17.071 24.001 8l9.071 9.071m-9.07 16.071v-25M40 35v6H8v-6" }, null, -1)];
  ...
  } }), wc = e.defineComponent({ name: "IconVoice", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-voice`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), bc = ["stroke-width", "stroke-linecap", "stroke-linejoin"], jc = [e.createElementVNode("path", { d: "M41 21v1c0 8.837-7.163 16-16 16h-2c-8.837 0-16-7.163-16-16v-1m17 17v6m0-14a9 9 0 0 1-9-9v-6a9 9 0 1 1 18 0v6a9 9 0 0 1-9 9Z" }, null, -1)];
  ...
  } }), Bc = e.defineComponent({ name: "IconAlignCenter", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-align-center`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Cc = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Nc = [e.createElementVNode("path", { d: "M44 9H4m38 20H6m28-10H14m20 20H14" }, null, -1)];
  var $c = r(Bc, [["render", function(t2, n2, o2, i2, r2, s2) {
    return e.openBlock(), e.createElementBlock("svg", { viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg", stroke: "currentColor", class: e.normalizeClass(t2.cls), style: e.normalizeStyle(t2.sizeStyle), "stroke-width": t2.strokeWidth, "stroke-linecap": t2.strokeLinecap, "stroke-linejoin": t2.strokeLinejoin }, Nc, 14, Cc);
  }]]);
  const Ec = Object.assign($c, { install: (e2, t2) => {
    var _a2;
    const n2 = (_a2 = t2 == null ? void 0 : t2.iconPrefix) != null ? _a2 : "";
    e2.component(n2 + $c.name, $c);
  } }), Mc = e.defineComponent({ name: "IconAlignLeft", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
  ...
  } }), Pc = e.defineComponent({ name: "IconAlignRight", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-align-right`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), qc = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Oc = [e.createElementVNode("path", { d: "M4 9h40M8 29h36M23 19h21M23 39h21" }, null, -1)];
  ...
  } }), Qc = e.defineComponent({ name: "IconBold", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-bold`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Gc = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Xc = [e.createElementVNode("path", { d: "M13 24h12a8 8 0 1 0 0-16H13.2a.2.2 0 0 0-.2.2V24Zm0 0h16a8 8 0 1 1 0 16H13.2a.2.2 0 0 1-.2-.2V24Z" }, null, -1)];
  var Jc = r(Qc, [["render", function(t2, n2, o2, i2, r2, s2) {
    return e.openBlock(), e.createElementBlock("svg", { viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg", stroke: "currentColor", class: e.normalizeClass(t2.cls), style: e.normalizeStyle(t2.sizeStyle), "stroke-width": t2.strokeWidth, "stroke-linecap": t2.strokeLinecap, "stroke-linejoin": t2.strokeLinejoin }, Xc, 14, Gc);
  }]]);
  const Kc = Object.assign(Jc, { install: (e2, t2) => {
    var _a2;
    const n2 = (_a2 = t2 == null ? void 0 : t2.iconPrefix) != null ? _a2 : "";
    e2.component(n2 + Jc.name, Jc);
  } }), Yc = e.defineComponent({ name: "IconBrush", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-brush`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), _c = ["stroke-width", "stroke-linecap", "stroke-linejoin"], ea = [e.createElementVNode("path", { d: "M33 13h7a1 1 0 0 1 1 1v12.14a1 1 0 0 1-.85.99l-21.3 3.24a1 1 0 0 0-.85.99V43M33 8v10.002A.998.998 0 0 1 32 19H8a1 1 0 0 1-1-1V8c0-.552.444-1 .997-1H32.01c.552 0 .99.447.99 1Z" }, null, -1)];
  ...
  } }), oa = e.defineComponent({ name: "IconCopy", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-copy`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), ia = ["stroke-width", "stroke-linecap", "stroke-linejoin"], ra = [e.createElementVNode("path", { d: "M20 6h18a2 2 0 0 1 2 2v22M8 16v24c0 1.105.891 2 1.996 2h20.007A1.99 1.99 0 0 0 32 40.008V15.997A1.997 1.997 0 0 0 30 14H10a2 2 0 0 0-2 2Z" }, null, -1)];
  ...
  } }), ca = e.defineComponent({ name: "IconDelete", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-delete`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), aa = ["stroke-width", "stroke-linecap", "stroke-linejoin"], pa = [e.createElementVNode("path", { d: "M5 11h5.5m0 0v29a1 1 0 0 0 1 1h25a1 1 0 0 0 1-1V11m-27 0H16m21.5 0H43m-5.5 0H32m-16 0V7h16v4m-16 0h16M20 18v15m8-15v15" }, null, -1)];
  ...
  } }), ma = e.defineComponent({ name: "IconEdit", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-edit`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), ka = ["stroke-width", "stroke-linecap", "stroke-linejoin"], za = [e.createElementVNode("path", { d: "m30.48 19.038 5.733-5.734a1 1 0 0 0 0-1.414l-5.586-5.586a1 1 0 0 0-1.414 0l-5.734 5.734m7 7L15.763 33.754a1 1 0 0 1-.59.286l-6.048.708a1 1 0 0 1-1.113-1.069l.477-6.31a1 1 0 0 1 .29-.631l14.7-14.7m7 7-7-7M6 42h36" }, null, -1)];
  ...
  } }), ha = e.defineComponent({ name: "IconEraser", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-eraser`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), ya = ["stroke-width", "stroke-linecap", "stroke-linejoin"], ga = [e.createElementVNode("path", { d: "M25.5 40.503 14.914 40.5a1 1 0 0 1-.707-.293l-9-9a1 1 0 0 1 0-1.414L13.5 21.5m12 19.003L44 40.5m-18.5.003L29 37M13.5 21.5 26.793 8.207a1 1 0 0 1 1.414 0l14.086 14.086a1 1 0 0 1 0 1.414L29 37M13.5 21.5 29 37" }, null, -1)];
  ...
  const wa = Object.assign(Sa, { install: (e2, t2) => {
    ...
    const n2 = (_a2 = t2 == null ? void 0 : t2.iconPrefix) != null ? _a2 : "";
    e2.component(n2 + Sa.name, Sa);
  } }), ba = e.defineComponent({ name: "IconFilter", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-filter`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), ja = ["stroke-width", "stroke-linecap", "stroke-linejoin"], La = [e.createElementVNode("path", { d: "M30 42V22.549a1 1 0 0 1 .463-.844l10.074-6.41A1 1 0 0 0 41 14.45V8a1 1 0 0 0-1-1H8a1 1 0 0 0-1 1v6.451a1 1 0 0 0 .463.844l10.074 6.41a1 1 0 0 1 .463.844V37" }, null, -1)];
  ...
  const Ba = Object.assign(xa, { install: (e2, t2) => {
    var _a2;
    const n2 = (_a2 = t2 == null ? void 0 : t2.iconPrefix) != null ? _a2 : "";
    e2.component(n2 + xa.name, xa);
  } }), Ca = e.defineComponent({ name: "IconFindReplace", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-find-replace`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Na = ["stroke-width", "stroke-linecap", "stroke-linejoin"], $a = [e.createElementVNode("path", { d: "M42.353 40.854 36.01 34.51m0 0a9 9 0 0 1-15.364-6.364c0-5 4-9 9-9s9 4 9 9a8.972 8.972 0 0 1-2.636 6.364Zm5.636-26.365h-36m10 16h-10m10 16h-10" }, null, -1)];
  var Ea = r(Ca, [["render", function(t2, n2, o2, i2, r2, s2) {
  ...
  } }), Va = e.defineComponent({ name: "IconFontColors", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
  ...
  } }), qa = e.defineComponent({ name: "IconFormula", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-formula`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Oa = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Ha = [e.createElementVNode("path", { d: "M40 8H10a1 1 0 0 0-1 1v.546a1 1 0 0 0 .341.753L24.17 23.273a1 1 0 0 1 .026 1.482l-.195.183L9.343 37.7a1 1 0 0 0-.343.754V39a1 1 0 0 0 1 1h30" }, null, -1)];
  ...
  const Aa = Object.assign(Fa, { install: (e2, t2) => {
    ...
    const n2 = (_a2 = t2 == null ? void 0 : t2.iconPrefix) != null ? _a2 : "";
    e2.component(n2 + Fa.name, Fa);
  } }), Da = e.defineComponent({ name: "IconH1", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-h1`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Ra = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Ta = [e.createElementVNode("path", { d: "M6 6v18m0 0v18m0-18h20m0 0V6m0 18v18M40 42V21h-1l-6 3" }, null, -1)];
  ...
  const Qa = Object.assign(Ua, { install: (e2, t2) => {
    ...
    const n2 = (_a2 = t2 == null ? void 0 : t2.iconPrefix) != null ? _a2 : "";
    e2.component(n2 + Ua.name, Ua);
  } }), Ga = e.defineComponent({ name: "IconH2", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-h2`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Xa = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Ja = [e.createElementVNode("path", { d: "M6 6v18m0 0v18m0-18h20m0 0V6m0 18v18M44 40H32v-.5l7.5-9c.914-1.117 2.5-3 2.5-5 0-2.485-2.239-4.5-5-4.5s-5 2.515-5 5" }, null, -1)];
  ...
  } }), _a = e.defineComponent({ name: "IconH3", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-h3`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), ep = ["stroke-width", "stroke-linecap", "stroke-linejoin"], tp = [e.createElementVNode("path", { d: "M6 6v18m0 0v18m0-18h20m0 0V6m0 18v18M37.001 30h-2m2 0a5 5 0 0 0 0-10h-.556a4.444 4.444 0 0 0-4.444 4.444m5 5.556a5 5 0 0 1 0 10h-.556a4.444 4.444 0 0 1-4.444-4.444" }, null, -1)];
  ...
  } }), ip = e.defineComponent({ name: "IconH4", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-h4`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), rp = ["stroke-width", "stroke-linecap", "stroke-linejoin"], sp = [e.createElementVNode("path", { d: "M6 6v18m0 0v18m0-18h20m0 0V6m0 18v18m14.5-6H31v-1l8-15h1.5v16Zm0 0H44m-3.5 0v6" }, null, -1)];
  ...
  } }), ap = e.defineComponent({ name: "IconH5", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-h5`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), pp = ["stroke-width", "stroke-linecap", "stroke-linejoin"], up = [e.createElementVNode("path", { d: "M6 6v18m0 0v18m0-18h20m0 0V6m0 18v18M43 21H32.5v9h.5s1.5-1 4-1a5 5 0 0 1 5 5v1a5 5 0 0 1-5 5c-2.05 0-4.728-1.234-5.5-3" }, null, -1)];
  ...
  } }), kp = e.defineComponent({ name: "IconH6", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-h6`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), zp = ["stroke-width", "stroke-linecap", "stroke-linejoin"], fp = [e.createElementVNode("path", { d: "M6 6v18m0 0v18m0-18h20m0 0V6m0 18v18M32 34.5c0 3.038 2.239 5.5 5 5.5s5-2.462 5-5.5-2.239-5.5-5-5.5-5 2.462-5 5.5Zm0 0v-5.73c0-4.444 3.867-7.677 8-7.263.437.044.736.08.952.115" }, null, -1)];
  ...
  } }), yp = e.defineComponent({ name: "IconH7", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-h7`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), gp = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Sp = [e.createElementVNode("path", { d: "M6 6v18m0 0v18m0-18h20m0 0V6m0 18v18m4-21h12v1l-4.4 16-1.1 3.5" }, null, -1)];
  ...
  } }), jp = e.defineComponent({ name: "IconHighlight", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-highlight`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Lp = ["stroke-width", "stroke-linecap", "stroke-linejoin"], xp = [e.createElementVNode("path", { d: "M19 18V9.28a1 1 0 0 1 .758-.97l8-2A1 1 0 0 1 29 7.28V18m-10 0h-4a1 1 0 0 0-1 1v8h-4a1 1 0 0 0-1 1v15m10-25h10m0 0h4a1 1 0 0 1 1 1v8h4a1 1 0 0 1 1 1v15" }, null, -1)];
  var Bp = r(jp, [["render", function(t2, n2, o2, i2, r2, s2) {
  ...
  const Cp = Object.assign(Bp, { install: (e2, t2) => {
    var _a2;
    const n2 = (_a2 = t2 == null ? void 0 : t2.iconPrefix) != null ? _a2 : "";
    e2.component(n2 + Bp.name, Bp);
  } }), Np = e.defineComponent({ name: "IconItalic", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-italic`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), $p = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Ep = [e.createElementVNode("path", { d: "M18 8h9m8 0h-8m0 0-6 32m0 0h-8m8 0h9" }, null, -1)];
  ...
  } }), Ip = e.defineComponent({ name: "IconLineHeight", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-line-height`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Wp = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Zp = [e.createElementVNode("path", { d: "M4 8h14.5M33 8H18.5m0 0v34" }, null, -1), e.createElementVNode("path", { d: "M39 9.5 37 13h4l-2-3.5ZM39 38.5 37 35h4l-2 3.5Z", fill: "currentColor", stroke: "none" }, null, -1), e.createElementVNode("path", { d: "M39 13h2l-2-3.5-2 3.5h2Zm0 0v22m0 0h2l-2 3.5-2-3.5h2Z" }, null, -1)];
  ...
  } }), Rp = e.defineComponent({ name: "IconObliqueLine", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-oblique-line`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Tp = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Up = [e.createElementVNode("path", { d: "M29.506 6.502 18.493 41.498" }, null, -1)];
  ...
  } }), tu = ["stroke-width", "stroke-linecap", "stroke-linejoin"], nu = [e.createElementVNode("path", { d: "m5.5 11.5 5-2.5h1v32M34 11.5 39 9h1v32" }, null, -1), e.createElementVNode("path", { d: "M24 17h1v1h-1v-1ZM24 30h1v1h-1v-1Z", fill: "currentColor", stroke: "none" }, null, -1), e.createElementVNode("path", { d: "M24 17h1v1h-1v-1ZM24 30h1v1h-1v-1Z" }, null, -1)];
  ...
  } }), ru = e.defineComponent({ name: "IconPaste", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-paste`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), su = ["stroke-width", "stroke-linecap", "stroke-linejoin"], lu = [e.createElementVNode("rect", { x: "8", y: "14", width: "24", height: "28", rx: "1" }, null, -1), e.createElementVNode("path", { d: "M24 6h.01v.01H24V6ZM32 6h.01v.01H32V6ZM40 6h.01v.01H40V6ZM40 13h.01v.01H40V13ZM40 21h.01v.01H40V21Z", fill: "currentColor", stroke: "none" }, null, -1), e.createElementVNode("path", { d: "M24 6h.01v.01H24V6ZM32 6h.01v.01H32V6ZM40 6h.01v.01H40V6ZM40 13h.01v.01H40V13ZM40 21h.01v.01H40V21Z" }, null, -1)];
  ...
  } }), zu = e.defineComponent({ name: "IconRedo", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-redo`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), fu = ["stroke-width", "stroke-linecap", "stroke-linejoin"], vu = [e.createElementVNode("path", { d: "m32.678 23.78 7.778-7.778-7.778-7.778M39.19 16H18.5C12.149 16 7 21.15 7 27.5 7 33.852 12.149 39 18.5 39H31" }, null, -1)];
  ...
  } }), gu = e.defineComponent({ name: "IconScissor", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-scissor`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Su = ["stroke-width", "stroke-linecap", "stroke-linejoin"], wu = [e.createElementVNode("path", { d: "m40.293 7.707-23.05 23.05m0 0a6 6 0 1 0-8.485 8.485 6 6 0 0 0 8.485-8.485Zm13.514 0a6 6 0 1 0 8.485 8.485 6 6 0 0 0-8.485-8.485Zm0 0L7.707 7.707" }, null, -1)];
  ...
  } }), Lu = e.defineComponent({ name: "IconSortAscending", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-sort-ascending`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), xu = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Bu = [e.createElementVNode("path", { d: "M15 6v33.759a.1.1 0 0 1-.17.07L8 33m17-6h10.4v.65L27 39.35V40h11m-1-19L31.4 8h-.8L25 21" }, null, -1)];
  var Cu = r(Lu, [["render", function(t2, n2, o2, i2, r2, s2) {
    return e.openBlock(), e.createElementBlock("svg", { viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg", stroke: "currentColor", class: e.normalizeClass(t2.cls), style: e.normalizeStyle(t2.sizeStyle), "stroke-width": t2.strokeWidth, "stroke-linecap": t2.strokeLinecap, "stroke-linejoin": t2.strokeLinejoin }, Bu, 14, xu);
  }]]);
  const Nu = Object.assign(Cu, { install: (e2, t2) => {
    var _a2;
    const n2 = (_a2 = t2 == null ? void 0 : t2.iconPrefix) != null ? _a2 : "";
    e2.component(n2 + Cu.name, Cu);
  } }), $u = e.defineComponent({ name: "IconSortDescending", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-sort-descending`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Eu = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Mu = [e.createElementVNode("path", { d: "M25 27h10.4v.65L27 39.35V40h11m-21.999 2V7.24a.1.1 0 0 0-.17-.07L9 14m28 7L31.4 8h-.8L25 21" }, null, -1)];
  ...
  } }), Wu = e.defineComponent({ name: "IconSort", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-sort`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Zu = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Pu = [e.createElementVNode("path", { d: "M43 9H5m0 30h14m15.5-15H5" }, null, -1)];
  ...
  } }), Hu = e.defineComponent({ name: "IconStrikethrough", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-strikethrough`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Fu = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Au = [e.createElementVNode("path", { d: "M13 32c0 5.246 5.149 9 11.5 9S36 36.746 36 31.5c0-1.708-.5-4.5-3.5-5.695m0 0H43m-10.5 0H5M34 14.5C34 10.358 29.523 7 24 7s-10 3.358-10 7.5c0 1.794 1.6 4.21 3 5.5" }, null, -1)];
  ...
  } }), Tu = e.defineComponent({ name: "IconUnderline", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-underline`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Uu = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Qu = [e.createElementVNode("path", { d: "M13 5v17.5C13 27 15.5 33 24 33s11-5 11-10.5V5M9 41h30" }, null, -1)];
  ...
  } }), Ju = e.defineComponent({ name: "IconUndo", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-undo`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Ku = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Yu = [e.createElementVNode("path", { d: "m15.322 23.78-7.778-7.778 7.778-7.778M8.81 16H29.5C35.851 16 41 21.15 41 27.5 41 33.852 35.851 39 29.5 39H17" }, null, -1)];
  ...
  } }), td = e.defineComponent({ name: "IconUnorderedList", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-unordered-list`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), nd = ["stroke-width", "stroke-linecap", "stroke-linejoin"], od = [e.createElementVNode("path", { d: "M13 24h30M5 11h4m4 26h30M13 11h30M5 24h4M5 37h4" }, null, -1)];
  ...
  } }), sd = e.defineComponent({ name: "IconZoomIn", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-zoom-in`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), ld = ["stroke-width", "stroke-linecap", "stroke-linejoin"], cd = [e.createElementVNode("path", { d: "M32.607 32.607A14.953 14.953 0 0 0 37 22c0-8.284-6.716-15-15-15-8.284 0-15 6.716-15 15 0 8.284 6.716 15 15 15 4.142 0 7.892-1.679 10.607-4.393Zm0 0L41.5 41.5M29 22H15m7 7V15" }, null, -1)];
  ...
  } }), ud = e.defineComponent({ name: "IconZoomOut", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-zoom-out`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), dd = ["stroke-width", "stroke-linecap", "stroke-linejoin"], md = [e.createElementVNode("path", { d: "M32.607 32.607A14.953 14.953 0 0 0 37 22c0-8.284-6.716-15-15-15-8.284 0-15 6.716-15 15 0 8.284 6.716 15 15 15 4.142 0 7.892-1.679 10.607-4.393Zm0 0L41.5 41.5M29 22H15" }, null, -1)];
  ...
  } }), Sd = e.defineComponent({ name: "IconPauseCircleFill", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-pause-circle-fill`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), wd = ["stroke-width", "stroke-linecap", "stroke-linejoin"], bd = [e.createElementVNode("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M24 44c11.046 0 20-8.954 20-20S35.046 4 24 4 4 12.954 4 24s8.954 20 20 20Zm-6-27a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h3a1 1 0 0 0 1-1V18a1 1 0 0 0-1-1h-3Zm9 0a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h3a1 1 0 0 0 1-1V18a1 1 0 0 0-1-1h-3Z", fill: "currentColor", stroke: "none" }, null, -1)];
  ...
  } }), xd = e.defineComponent({ name: "IconPlayArrowFill", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-play-arrow-fill`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Bd = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Cd = [e.createElementVNode("path", { d: "M17.533 10.974a1 1 0 0 0-1.537.844v24.356a1 1 0 0 0 1.537.844L36.67 24.84a1 1 0 0 0 0-1.688L17.533 10.974Z", fill: "currentColor", stroke: "none" }, null, -1)];
  var Nd = r(xd, [["render", function(t2, n2, o2, i2, r2, s2) {
    return e.openBlock(), e.createElementBlock("svg", { viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg", stroke: "currentColor", class: e.normalizeClass(t2.cls), style: e.normalizeStyle(t2.sizeStyle), "stroke-width": t2.strokeWidth, "stroke-linecap": t2.strokeLinecap, "stroke-linejoin": t2.strokeLinejoin }, Cd, 14, Bd);
  }]]);
  const $d = Object.assign(Nd, { install: (e2, t2) => {
    var _a2;
    const n2 = (_a2 = t2 == null ? void 0 : t2.iconPrefix) != null ? _a2 : "";
    e2.component(n2 + Nd.name, Nd);
  } }), Ed = e.defineComponent({ name: "IconPlayCircleFill", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-play-circle-fill`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Md = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Vd = [e.createElementVNode("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M44 24c0 11.046-8.954 20-20 20S4 35.046 4 24 12.954 4 24 4s20 8.954 20 20Zm-23.662-7.783C19.302 15.605 18 16.36 18 17.575v12.85c0 1.214 1.302 1.97 2.338 1.358l10.89-6.425c1.03-.607 1.03-2.11 0-2.716l-10.89-6.425Z", fill: "currentColor", stroke: "none" }, null, -1)];
  ...
  } }), Fd = e.defineComponent({ name: "IconSkipPreviousFill", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-skip-previous-fill`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Ad = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Dd = [e.createElementVNode("path", { d: "M34.414 35.855a1 1 0 0 0 1.586-.81v-22.09a1 1 0 0 0-1.586-.81L19.122 23.19a1 1 0 0 0 0 1.622l15.292 11.044Z", fill: "currentColor", stroke: "none" }, null, -1), e.createElementVNode("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M15 12a1 1 0 0 1 1 1v22a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1V13a1 1 0 0 1 1-1h2Z", fill: "currentColor", stroke: "none" }, null, -1)];
  ...
  } }), Ud = e.defineComponent({ name: "IconSoundFill", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-sound-fill`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Qd = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Gd = [e.createElementVNode("path", { d: "m14 15 10-7v32l-10-7H6V15h8Z", fill: "currentColor", stroke: "none" }, null, -1), e.createElementVNode("path", { d: "M24.924 6.226A2 2 0 0 1 26 8v32a2 2 0 0 1-3.147 1.639L13.37 35H6a2 2 0 0 1-2-2V15a2 2 0 0 1 2-2h7.37l9.483-6.638a2 2 0 0 1 2.07-.136ZM35.314 35.042c6.248-6.249 6.248-16.38 0-22.628l2.828-2.828c7.81 7.81 7.81 20.474 0 28.284l-2.828-2.828Z", fill: "currentColor", stroke: "none" }, null, -1), e.createElementVNode("path", { d: "M29.657 29.728a8 8 0 0 0 0-11.314l2.828-2.828c4.687 4.686 4.687 12.284 0 16.97l-2.828-2.828Z", fill: "currentColor", stroke: "none" }, null, -1)];
  ...
  } }), Kd = e.defineComponent({ name: "IconBackward", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-backward`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Yd = ["stroke-width", "stroke-linecap", "stroke-linejoin"], _d = [e.createElementVNode("path", { d: "M38.293 36.293 26.707 24.707a1 1 0 0 1 0-1.414l11.586-11.586c.63-.63 1.707-.184 1.707.707v23.172c0 .89-1.077 1.337-1.707.707ZM21 12.414v23.172c0 .89-1.077 1.337-1.707.707L7.707 24.707a1 1 0 0 1 0-1.414l11.586-11.586c.63-.63 1.707-.184 1.707.707Z" }, null, -1)];
  ...
  } }), lm = e.defineComponent({ name: "IconFullscreenExit", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-fullscreen-exit`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), cm = ["stroke-width", "stroke-linecap", "stroke-linejoin"], am = [e.createElementVNode("path", { d: "M35 6v8a1 1 0 0 0 1 1h8M13 6v8a1 1 0 0 1-1 1H4m31 27v-8a1 1 0 0 1 1-1h8m-31 9v-8a1 1 0 0 0-1-1H4" }, null, -1)];
  ...
  } }), dm = e.defineComponent({ name: "IconFullscreen", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-fullscreen`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), mm = ["stroke-width", "stroke-linecap", "stroke-linejoin"], km = [e.createElementVNode("path", { d: "M42 17V9a1 1 0 0 0-1-1h-8M6 17V9a1 1 0 0 1 1-1h8m27 23v8a1 1 0 0 1-1 1h-8M6 31v8a1 1 0 0 0 1 1h8" }, null, -1)];
  ...
  } }), vm = e.defineComponent({ name: "IconLiveBroadcast", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-live-broadcast`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), hm = ["stroke-width", "stroke-linecap", "stroke-linejoin"], ym = [e.createElementVNode("path", { d: "M29 16h12a1 1 0 0 1 1 1v22a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V17a1 1 0 0 1 1-1h12m10 0 8-9m-8 9H19m0 0-8-9m17.281 21.88-6.195 4.475a1 1 0 0 1-1.586-.81v-8.262a1 1 0 0 1 1.521-.853l6.196 3.786a1 1 0 0 1 .064 1.664Z" }, null, -1)];
  ...
  } }), wm = e.defineComponent({ name: "IconMusic", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-music`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), bm = ["stroke-width", "stroke-linecap", "stroke-linejoin"], jm = [e.createElementVNode("path", { d: "M15 37a4 4 0 1 0-8 0 4 4 0 0 0 8 0Zm0 0V18.5M41 37a4 4 0 1 0-8 0 4 4 0 0 0 8 0Zm0 0V16.5m-26 2V9.926a1 1 0 0 1 .923-.997l24-1.846A1 1 0 0 1 41 8.08v8.42m-26 2 26-2" }, null, -1)];
  ...
  } }), Bm = e.defineComponent({ name: "IconMute", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-mute`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Cm = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Nm = [e.createElementVNode("path", { d: "m19 11.5 4.833-4.35a.1.1 0 0 1 .167.075V17m-14-1H7.1a.1.1 0 0 0-.1.1v15.8a.1.1 0 0 0 .1.1H14l9.833 8.85a.1.1 0 0 0 .167-.075V31m6.071-14.071C32.535 19.393 34 23 32.799 26m2.929-14.728C41.508 17.052 42.5 25 39.123 32M6.5 6.5l35 35" }, null, -1)];
  var $m = r(Bm, [["render", function(t2, n2, o2, i2, r2, s2) {
    return e.openBlock(), e.createElementBlock("svg", { viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg", stroke: "currentColor", class: e.normalizeClass(t2.cls), style: e.normalizeStyle(t2.sizeStyle), "stroke-width": t2.strokeWidth, "stroke-linecap": t2.strokeLinecap, "stroke-linejoin": t2.strokeLinejoin }, Nm, 14, Cm);
  }]]);
  const Em = Object.assign($m, { install: (e2, t2) => {
    var _a2;
    const n2 = (_a2 = t2 == null ? void 0 : t2.iconPrefix) != null ? _a2 : "";
    e2.component(n2 + $m.name, $m);
  } }), Mm = e.defineComponent({ name: "IconPauseCircle", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-pause-circle`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Vm = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Im = [e.createElementVNode("path", { d: "M42 24c0 9.941-8.059 18-18 18S6 33.941 6 24 14.059 6 24 6s18 8.059 18 18Z" }, null, -1), e.createElementVNode("path", { d: "M19 19v10h1V19h-1ZM28 19v10h1V19h-1Z" }, null, -1)];
  ...
  } }), Pm = e.defineComponent({ name: "IconPause", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-pause`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), qm = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Om = [e.createElementVNode("path", { d: "M14 12h4v24h-4zM30 12h4v24h-4z" }, null, -1), e.createElementVNode("path", { fill: "currentColor", stroke: "none", d: "M14 12h4v24h-4zM30 12h4v24h-4z" }, null, -1)];
  ...
  } }), Am = e.defineComponent({ name: "IconPlayArrow", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-play-arrow`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Dm = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Rm = [e.createElementVNode("path", { d: "M12.533 7.965A1 1 0 0 0 11 8.81v30.377a1 1 0 0 0 1.533.846L36.656 24.84a1 1 0 0 0 0-1.692L12.533 7.965Z" }, null, -1)];
  ...
  } }), Qm = e.defineComponent({ name: "IconPlayCircle", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-play-circle`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Gm = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Xm = [e.createElementVNode("path", { d: "M24 42c9.941 0 18-8.059 18-18S33.941 6 24 6 6 14.059 6 24s8.059 18 18 18Z" }, null, -1), e.createElementVNode("path", { d: "M19 17v14l12-7-12-7Z" }, null, -1)];
  ...
  } }), Ym = e.defineComponent({ name: "IconRecordStop", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-record-stop`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), _m = ["stroke-width", "stroke-linecap", "stroke-linejoin"], ek = [e.createElementVNode("path", { "clip-rule": "evenodd", d: "M24 6c9.941 0 18 8.059 18 18s-8.059 18-18 18S6 33.941 6 24 14.059 6 24 6Z" }, null, -1), e.createElementVNode("path", { d: "M19 20a1 1 0 0 1 1-1h8a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1h-8a1 1 0 0 1-1-1v-8Z", fill: "currentColor", stroke: "none" }, null, -1), e.createElementVNode("path", { d: "M19 20a1 1 0 0 1 1-1h8a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1h-8a1 1 0 0 1-1-1v-8Z" }, null, -1)];
  ...
  } }), ok = e.defineComponent({ name: "IconRecord", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-record`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), ik = ["stroke-width", "stroke-linecap", "stroke-linejoin"], rk = [e.createElementVNode("path", { "clip-rule": "evenodd", d: "M24 6c9.941 0 18 8.059 18 18s-8.059 18-18 18S6 33.941 6 24 14.059 6 24 6Z" }, null, -1), e.createElementVNode("path", { d: "M30 24a6 6 0 1 1-12 0 6 6 0 0 1 12 0Z", fill: "currentColor", stroke: "none" }, null, -1), e.createElementVNode("path", { d: "M30 24a6 6 0 1 1-12 0 6 6 0 0 1 12 0Z" }, null, -1)];
  ...
  } }), ck = e.defineComponent({ name: "IconSkipNext", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-skip-next`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), ak = ["stroke-width", "stroke-linecap", "stroke-linejoin"], pk = [e.createElementVNode("path", { d: "M34 24 10 40V8l24 16Z" }, null, -1), e.createElementVNode("path", { d: "M38 6v36" }, null, -1)];
  ...
  } }), mk = e.defineComponent({ name: "IconSkipPrevious", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-skip-previous`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), kk = ["stroke-width", "stroke-linecap", "stroke-linejoin"], zk = [e.createElementVNode("path", { d: "m14 24 24 16V8L14 24Z" }, null, -1), e.createElementVNode("path", { d: "M10 6v36" }, null, -1)];
  ...
  } }), hk = e.defineComponent({ name: "IconSound", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-sound`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), yk = ["stroke-width", "stroke-linecap", "stroke-linejoin"], gk = [e.createElementVNode("path", { d: "m14 16 10-9v34l-10-9H6V16h8Z" }, null, -1), e.createElementVNode("path", { d: "M31.071 16.929c3.905 3.905 3.905 10.237 0 14.142M36.727 11.272c7.03 7.03 7.03 18.426 0 25.456" }, null, -1)];
  ...
  } }), qk = e.defineComponent({ name: "IconXiguaColor", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-xigua-color`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Ok = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Hk = [e.createElementVNode("path", { d: "M381.968 38.684c-202.85 54.614-351.085 232.757-371.89 446.01C-.326 590.018 28.281 630.328 140.108 668.037c104.026 33.808 176.843 101.425 209.351 189.846 40.31 115.729 44.211 122.23 91.023 144.336 40.31 19.504 58.514 19.504 131.332 7.802 211.951-36.41 362.788-171.642 416.101-374.492C1059.434 368.965 882.59 90.697 605.623 32.183 517.2 13.978 470.39 15.279 381.968 38.684zm176.843 322.48c158.64 74.117 201.55 158.638 119.63 237.957-102.725 97.524-240.56 136.534-291.271 80.62-20.806-23.406-24.707-48.112-24.707-161.24s3.901-137.833 24.707-161.239c32.507-36.409 88.421-35.108 171.641 3.901z", fill: "#FE163E" }, null, -1)];
  ...
  const Ak = Object.assign(Fk, { install: (e2, t2) => {
    ...
    const n2 = (_a2 = t2 == null ? void 0 : t2.iconPrefix) != null ? _a2 : "";
    e2.component(n2 + Fk.name, Fk);
  } }), Dk = e.defineComponent({ name: "IconFaceBookCircleFill", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-faceBook-circle-fill`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Rk = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Tk = [e.createElementVNode("path", { d: "M24 1C11.29 1 1 11.29 1 24s10.29 23 23 23 23-10.29 23-23S36.71 1 24 1Zm6.172 22.88H26.18v14.404h-5.931V23.88H17.22v-4.962h3.027V15.89c0-3.993 1.695-6.414 6.414-6.414h3.993v4.962h-2.421c-1.815 0-1.936.727-1.936 1.936v2.421h4.478l-.605 5.084h.001Z", fill: "currentColor", stroke: "none" }, null, -1)];
  var Uk = r(Dk, [["render", function(t2, n2, o2, i2, r2, s2) {
    return e.openBlock(), e.createElementBlock("svg", { viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg", stroke: "currentColor", class: e.normalizeClass(t2.cls), style: e.normalizeStyle(t2.sizeStyle), "stroke-width": t2.strokeWidth, "stroke-linecap": t2.strokeLinecap, "stroke-linejoin": t2.strokeLinejoin }, Tk, 14, Rk);
  }]]);
  const Qk = Object.assign(Uk, { install: (e2, t2) => {
    var _a2;
    const n2 = (_a2 = t2 == null ? void 0 : t2.iconPrefix) != null ? _a2 : "";
    e2.component(n2 + Uk.name, Uk);
  } }), Gk = e.defineComponent({ name: "IconFacebookSquareFill", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-facebook-square-fill`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Xk = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Jk = [e.createElementVNode("path", { d: "M43.125 2.475c.6 0 1.2.225 1.688.713.524.487.75 1.012.75 1.612v38.363c0 .6-.263 1.2-.75 1.612-.526.488-1.088.713-1.688.713H32.138V28.913h5.625l.825-6.563h-6.45v-4.275c0-2.137 1.087-3.225 3.3-3.225h3.374V9.263c-1.2-.225-2.85-.338-5.024-.338-2.513 0-4.5.75-6.038 2.25-1.538 1.5-2.288 3.675-2.288 6.375v4.8h-5.625v6.563h5.625v16.575h-20.7c-.6 0-1.2-.225-1.612-.713-.487-.487-.712-1.012-.712-1.612V4.8c0-.6.224-1.2.712-1.612.488-.488 1.012-.713 1.613-.713h38.362Z", fill: "currentColor", stroke: "none" }, null, -1)];
  var Kk = r(Gk, [["render", function(t2, n2, o2, i2, r2, s2) {
    return e.openBlock(), e.createElementBlock("svg", { viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg", stroke: "currentColor", class: e.normalizeClass(t2.cls), style: e.normalizeStyle(t2.sizeStyle), "stroke-width": t2.strokeWidth, "stroke-linecap": t2.strokeLinecap, "stroke-linejoin": t2.strokeLinejoin }, Jk, 14, Xk);
  }]]);
  const Yk = Object.assign(Kk, { install: (e2, t2) => {
    var _a2;
    const n2 = (_a2 = t2 == null ? void 0 : t2.iconPrefix) != null ? _a2 : "";
    e2.component(n2 + Kk.name, Kk);
  } }), _k = e.defineComponent({ name: "IconGoogleCircleFill", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-google-circle-fill`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), ez = ["stroke-width", "stroke-linecap", "stroke-linejoin"], tz = [e.createElementVNode("path", { d: "M32.571 33.526c-2.084 1.92-4.927 3.05-8.322 3.05a12.568 12.568 0 0 1-12.572-12.577A12.58 12.58 0 0 1 24.25 11.416a12.103 12.103 0 0 1 8.414 3.277L29.061 18.3a6.787 6.787 0 0 0-4.807-1.88c-3.277 0-6.045 2.213-7.037 5.186a7.567 7.567 0 0 0-.394 2.392c0 .833.144 1.638.394 2.391.992 2.973 3.763 5.187 7.032 5.187 1.696 0 3.133-.449 4.254-1.202a5.778 5.778 0 0 0 2.513-3.8h-6.767V21.71h11.844c.15.825.227 1.682.227 2.57 0 3.835-1.371 7.055-3.749 9.246ZM24 1A23 23 0 1 0 24 47 23 23 0 0 0 24 1Z", fill: "currentColor", stroke: "none" }, null, -1)];
  ...
  } }), iz = e.defineComponent({ name: "IconQqCircleFill", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-qq-circle-fill`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), rz = ["stroke-width", "stroke-linecap", "stroke-linejoin"], sz = [e.createElementVNode("path", { d: "M24.007 1C11.281 1 1 11.281 1 24.007c0 13.23 11.216 23.87 24.733 22.936 11.288-.791 20.49-9.994 21.21-21.354C47.877 12.144 37.237 1 24.007 1Zm11.36 29.262s-.79 2.23-2.3 4.242c0 0 2.66.935 2.444 3.236 0 0 .072 2.66-5.68 2.444 0 0-4.026-.287-5.248-2.013h-1.079c-1.222 1.726-5.248 2.013-5.248 2.013-5.752.216-5.68-2.444-5.68-2.444-.216-2.373 2.444-3.236 2.444-3.236-1.51-2.013-2.3-4.241-2.3-4.241-3.596 5.895-3.236-.791-3.236-.791.647-3.955 3.523-6.543 3.523-6.543-.431-3.595 1.078-4.242 1.078-4.242.216-11.072 9.707-10.929 9.922-10.929.216 0 9.707-.215 9.994 10.929 0 0 1.51.647 1.079 4.242 0 0 2.876 2.588 3.523 6.543 0 0 .36 6.686-3.236.79Z", fill: "currentColor", stroke: "none" }, null, -1)];
  ...
  const Cz = Object.assign(Bz, { install: (e2, t2) => {
    var _a2;
    const n2 = (_a2 = t2 == null ? void 0 : t2.iconPrefix) != null ? _a2 : "";
    e2.component(n2 + Bz.name, Bz);
  } }), Nz = e.defineComponent({ name: "IconCodepen", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-codepen`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), $z = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Ez = [e.createElementVNode("path", { d: "M45 15.7v17.1L24.5 44.7c-.3.2-.7.2-1 0l-20-11.5c-.3-.2-.5-.5-.5-.9V15.7c0-.4.2-.7.5-.9l20-11.6c.3-.2.7-.2 1 0l20 11.6c.3.2.5.5.5.9ZM26 9v9.8l5.5 3.2 8.5-4.9L26 9Zm-4 0L8 17.1l8.4 4.9 5.6-3.2V9Zm0 21.2L16.5 27 9 31.4 22 39v-8.8Zm17 1.2L31.4 27 26 30.2V39l13-7.6Zm2-3.4v-6l-5 3 5 3Zm-29-3-5-3v6l5-3Zm8 0 4 2 4-2-4-2-4 2Z", fill: "currentColor", stroke: "none" }, null, -1)];
  ...
  } }), Iz = e.defineComponent({ name: "IconFacebook", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-facebook`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Wz = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Zz = [e.createElementVNode("path", { d: "M35.184 15.727 34.312 24h-6.613v24h-9.933V24h-4.95v-8.273h4.95v-4.98C17.766 4.016 20.564 0 28.518 0h6.61v8.273H30.99c-3.086 0-3.292 1.166-3.292 3.32v4.134h7.485Z", fill: "currentColor", stroke: "none" }, null, -1)];
  ...
  } }), Sf = e.defineComponent({ name: "IconWechatpay", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-wechatpay`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), wf = ["stroke-width", "stroke-linecap", "stroke-linejoin"], bf = [e.createElementVNode("path", { d: "M17.514 29.52a1.502 1.502 0 0 1-.715.165c-.608 0-1.104-.33-1.38-.826l-.113-.219-4.357-9.493c-.054-.112-.054-.219-.054-.33 0-.444.331-.774.774-.774.165 0 .33.053.496.165l5.13 3.643c.384.218.827.384 1.323.384.277 0 .55-.054.827-.166l24.058-10.704C39.2 6.288 32.085 2.976 24.026 2.976 10.896 2.976.191 11.861.191 22.837c0 5.958 3.2 11.366 8.22 15.008.383.278.66.774.66 1.27 0 .165-.053.33-.112.496-.384 1.488-1.05 3.92-1.05 4.026a2.025 2.025 0 0 0-.112.608c0 .443.33.774.773.774.165 0 .33-.054.443-.166l5.184-3.034c.384-.219.826-.384 1.27-.384.218 0 .495.053.714.112a27.712 27.712 0 0 0 7.781 1.104c13.13 0 23.835-8.886 23.835-19.862 0-3.312-.992-6.453-2.704-9.216L17.679 29.408l-.165.112Z", fill: "currentColor", stroke: "none" }, null, -1)];
  ...
  } }), Zf = e.defineComponent({ name: "IconEnglishFill", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-english-fill`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Pf = ["stroke-width", "stroke-linecap", "stroke-linejoin"], qf = [e.createElementVNode("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M23.2 4C12.596 4 4 12.596 4 23.2v1.6C4 35.404 12.596 44 23.2 44h1.6C35.404 44 44 35.404 44 24.8v-1.6C44 12.596 35.404 4 24.8 4h-1.6Zm-9.086 10A2.114 2.114 0 0 0 12 16.114v15.772c0 1.167.947 2.114 2.114 2.114H25v-4h-9v-4h7.778v-4H16v-4h9v-4H14.114ZM32.4 22a5.4 5.4 0 0 0-5.4 5.4V34h4v-6.6a1.4 1.4 0 0 1 2.801 0V34h4v-6.6a5.4 5.4 0 0 0-5.4-5.4Z", fill: "currentColor", stroke: "none" }, null, -1)];
  ...
  const Hf = Object.assign(Of, { install: (e2, t2) => {
    ...
    const n2 = (_a2 = t2 == null ? void 0 : t2.iconPrefix) != null ? _a2 : "";
    e2.component(n2 + Of.name, Of);
  } }), Ff = e.defineComponent({ name: "IconFaceFrownFill", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-face-frown-fill`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Af = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Df = [e.createElementVNode("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M24 44c11.046 0 20-8.954 20-20S35.046 4 24 4 4 12.954 4 24s8.954 20 20 20Zm7.322-26.873a2.625 2.625 0 1 1 0 5.25 2.625 2.625 0 0 1 0-5.25Zm-14.646 0a2.625 2.625 0 1 1 0 5.25 2.625 2.625 0 0 1 0-5.25ZM31.68 32.88a1.91 1.91 0 0 1-2.694-.176 6.66 6.66 0 0 0-5.026-2.28c-1.918 0-3.701.81-4.962 2.207a1.91 1.91 0 0 1-2.834-2.559 10.476 10.476 0 0 1 7.796-3.465c3.063 0 5.916 1.321 7.896 3.58a1.909 1.909 0 0 1-.176 2.693Z", fill: "currentColor", stroke: "none" }, null, -1)];
  ...
  } }), Uf = e.defineComponent({ name: "IconFaceMehFill", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-face-meh-fill`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Qf = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Gf = [e.createElementVNode("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M24 44c11.046 0 20-8.954 20-20S35.046 4 24 4 4 12.954 4 24s8.954 20 20 20Zm7.321-26.873a2.625 2.625 0 1 1 0 5.25 2.625 2.625 0 0 1 0-5.25Zm-14.646 0a2.625 2.625 0 1 1 0 5.25 2.625 2.625 0 0 1 0-5.25ZM15.999 30a2 2 0 0 1 2-2h12a2 2 0 1 1 0 4H18a2 2 0 0 1-2-2Z", fill: "currentColor", stroke: "none" }, null, -1)];
  ...
  } }), lv = e.defineComponent({ name: "IconPenFill", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-pen-fill`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), cv = ["stroke-width", "stroke-linecap", "stroke-linejoin"], av = [e.createElementVNode("path", { fill: "currentColor", stroke: "none", d: "m31.07 8.444 8.485 8.485L19.05 37.435l-8.485-8.485zM33.9 5.615a2 2 0 0 1 2.829 0l5.657 5.657a2 2 0 0 1 0 2.829l-1.415 1.414-8.485-8.486L33.9 5.615ZM17.636 38.85 9.15 30.363l-3.61 10.83a1 1 0 0 0 1.265 1.265l10.83-3.61Z" }, null, -1)];
  ...
  } }), vv = e.defineComponent({ name: "IconApps", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-apps`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), hv = ["stroke-width", "stroke-linecap", "stroke-linejoin"], yv = [e.createElementVNode("path", { d: "M7 7h13v13H7zM28 7h13v13H28zM7 28h13v13H7zM28 28h13v13H28z" }, null, -1)];
  ...
  } }), wv = e.defineComponent({ name: "IconBook", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-book`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), bv = ["stroke-width", "stroke-linecap", "stroke-linejoin"], jv = [e.createElementVNode("path", { d: "M24 13 7 7v28l17 6 17-6V7l-17 6Zm0 0v27.5M29 18l7-2.5M29 25l7-2.5M29 32l7-2.5M19 18l-7-2.5m7 9.5-7-2.5m7 9.5-7-2.5" }, null, -1)];
  ...
  } }), Bv = e.defineComponent({ name: "IconBranch", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-branch`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Cv = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Nv = [e.createElementVNode("path", { d: "M19 10a4 4 0 1 1-8 0 4 4 0 0 1 8 0ZM38 10a4 4 0 1 1-8 0 4 4 0 0 1 8 0ZM19 38a4 4 0 1 1-8 0 4 4 0 0 1 8 0ZM15 15v15m0 3.5V30m0 0c0-5 19-7 19-15" }, null, -1)];
  var $v = r(Bv, [["render", function(t2, n2, o2, i2, r2, s2) {
    return e.openBlock(), e.createElementBlock("svg", { viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg", stroke: "currentColor", class: e.normalizeClass(t2.cls), style: e.normalizeStyle(t2.sizeStyle), "stroke-width": t2.strokeWidth, "stroke-linecap": t2.strokeLinecap, "stroke-linejoin": t2.strokeLinejoin }, Nv, 14, Cv);
  }]]);
  const Ev = Object.assign($v, { install: (e2, t2) => {
    var _a2;
    const n2 = (_a2 = t2 == null ? void 0 : t2.iconPrefix) != null ? _a2 : "";
    e2.component(n2 + $v.name, $v);
  } }), Mv = e.defineComponent({ name: "IconBug", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-bug`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Vv = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Iv = [e.createElementVNode("path", { d: "M24 42c-6.075 0-11-4.925-11-11V18h22v13c0 6.075-4.925 11-11 11Zm0 0V23m11 4h8M5 27h8M7 14a4 4 0 0 0 4 4h26a4 4 0 0 0 4-4m0 28v-.5a6.5 6.5 0 0 0-6.5-6.5M7 42v-.5a6.5 6.5 0 0 1 6.5-6.5M17 14a7 7 0 1 1 14 0" }, null, -1)];
  var Wv = r(Mv, [["render", function(t2, n2, o2, i2, r2, s2) {
    return e.openBlock(), e.createElementBlock("svg", { viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg", stroke: "currentColor", class: e.normalizeClass(t2.cls), style: e.normalizeStyle(t2.sizeStyle), "stroke-width": t2.strokeWidth, "stroke-linecap": t2.strokeLinecap, "stroke-linejoin": t2.strokeLinejoin }, Iv, 14, Vv);
  }]]);
  const Zv = Object.assign(Wv, { install: (e2, t2) => {
    var _a2;
    const n2 = (_a2 = t2 == null ? void 0 : t2.iconPrefix) != null ? _a2 : "";
    e2.component(n2 + Wv.name, Wv);
  } }), Pv = e.defineComponent({ name: "IconBulb", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-bulb`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), qv = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Ov = [e.createElementVNode("path", { d: "M17 42h14m6-24c0 2.823-.9 5.437-2.43 7.568-1.539 2.147-3.185 4.32-3.77 6.897l-.623 2.756A1 1 0 0 1 29.2 36H18.8a1 1 0 0 1-.976-.779l-.624-2.756c-.584-2.576-2.23-4.75-3.77-6.897A12.94 12.94 0 0 1 11 18c0-7.18 5.82-13 13-13s13 5.82 13 13Z" }, null, -1)];
  var Hv = r(Pv, [["render", function(t2, n2, o2, i2, r2, s2) {
    return e.openBlock(), e.createElementBlock("svg", { viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg", stroke: "currentColor", class: e.normalizeClass(t2.cls), style: e.normalizeStyle(t2.sizeStyle), "stroke-width": t2.strokeWidth, "stroke-linecap": t2.strokeLinecap, "stroke-linejoin": t2.strokeLinejoin }, Ov, 14, qv);
  }]]);
  const Fv = Object.assign(Hv, { install: (e2, t2) => {
    var _a2;
    const n2 = (_a2 = t2 == null ? void 0 : t2.iconPrefix) != null ? _a2 : "";
    e2.component(n2 + Hv.name, Hv);
  } }), Av = e.defineComponent({ name: "IconCalendar", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-calendar`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Dv = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Rv = [e.createElementVNode("path", { d: "M7 22h34M14 5v8m20-8v8M8 41h32a1 1 0 0 0 1-1V10a1 1 0 0 0-1-1H8a1 1 0 0 0-1 1v30a1 1 0 0 0 1 1Z" }, null, -1)];
  ...
  } }), Qv = e.defineComponent({ name: "IconCamera", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-camera`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Gv = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Xv = [e.createElementVNode("path", { d: "m33 12-1.862-3.724A.5.5 0 0 0 30.691 8H17.309a.5.5 0 0 0-.447.276L15 12m16 14a7 7 0 1 1-14 0 7 7 0 0 1 14 0ZM7 40h34a1 1 0 0 0 1-1V13a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1v26a1 1 0 0 0 1 1Z" }, null, -1)];
  var Jv = r(Qv, [["render", function(t2, n2, o2, i2, r2, s2) {
    return e.openBlock(), e.createElementBlock("svg", { viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg", stroke: "currentColor", class: e.normalizeClass(t2.cls), style: e.normalizeStyle(t2.sizeStyle), "stroke-width": t2.strokeWidth, "stroke-linecap": t2.strokeLinecap, "stroke-linejoin": t2.strokeLinejoin }, Xv, 14, Gv);
  }]]);
  const Kv = Object.assign(Jv, { install: (e2, t2) => {
    var _a2;
    const n2 = (_a2 = t2 == null ? void 0 : t2.iconPrefix) != null ? _a2 : "";
    e2.component(n2 + Jv.name, Jv);
  } }), Yv = e.defineComponent({ name: "IconCloud", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-cloud`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), _v = ["stroke-width", "stroke-linecap", "stroke-linejoin"], eh = [e.createElementVNode("path", { d: "M5 29a9 9 0 0 0 9 9h19c5.523 0 10-4.477 10-10 0-5.312-4.142-9.657-9.373-9.98C32.3 12.833 27.598 9 22 9c-6.606 0-11.965 5.338-12 11.935A9 9 0 0 0 5 29Z" }, null, -1)];
  ...
  } }), oh = e.defineComponent({ name: "IconCommand", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-command`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), ih = ["stroke-width", "stroke-linecap", "stroke-linejoin"], rh = [e.createElementVNode("path", { d: "M29 19v-6a6 6 0 1 1 6 6h-6Zm0 0v10m0-10H19m10 10v6a6 6 0 1 0 6-6h-6Zm0 0H19m0-10v10m0-10v-6a6 6 0 1 0-6 6h6Zm0 10v6a6 6 0 1 1-6-6h6Z" }, null, -1)];
  ...
  } }), ch = e.defineComponent({ name: "IconCommon", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-common`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), ah = ["stroke-width", "stroke-linecap", "stroke-linejoin"], ph = [e.createElementVNode("path", { d: "M24 23 7.652 14.345M24 23l16.366-8.664M24 23v19.438M7 14v20l17 9 17-9V14L24 5 7 14Z" }, null, -1)];
  ...
  } }), mh = e.defineComponent({ name: "IconCompass", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-compass`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), kh = ["stroke-width", "stroke-linecap", "stroke-linejoin"], zh = [e.createElementVNode("path", { d: "M42 24c0 9.941-8.059 18-18 18S6 33.941 6 24 14.059 6 24 6s18 8.059 18 18Z" }, null, -1), e.createElementVNode("path", { d: "m21.177 21.183 10.108-4.717a.2.2 0 0 1 .266.265L26.834 26.84l-10.109 4.717a.2.2 0 0 1-.266-.266l4.718-10.108Z" }, null, -1)];
  ...
  } }), hh = e.defineComponent({ name: "IconCopyright", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-copyright`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), yh = ["stroke-width", "stroke-linecap", "stroke-linejoin"], gh = [e.createElementVNode("path", { d: "M29.292 18a8 8 0 1 0 0 12M42 24c0 9.941-8.059 18-18 18S6 33.941 6 24 14.059 6 24 6s18 8.059 18 18Z" }, null, -1)];
  ...
  const wh = Object.assign(Sh, { install: (e2, t2) => {
    ...
    const n2 = (_a2 = t2 == null ? void 0 : t2.iconPrefix) != null ? _a2 : "";
    e2.component(n2 + Sh.name, Sh);
  } }), bh = e.defineComponent({ name: "IconDashboard", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-dashboard`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), jh = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Lh = [e.createElementVNode("path", { d: "M41.808 24c.118 4.63-1.486 9.333-5.21 13m5.21-13h-8.309m8.309 0c-.112-4.38-1.767-8.694-4.627-12M24 6c5.531 0 10.07 2.404 13.18 6M24 6c-5.724 0-10.384 2.574-13.5 6.38M24 6v7.5M37.18 12 31 17.5m-20.5-5.12L17 17.5m-6.5-5.12C6.99 16.662 5.44 22.508 6.53 28m4.872 9c-2.65-2.609-4.226-5.742-4.873-9m0 0 8.97-3.5" }, null, -1), e.createElementVNode("path", { d: "M24 32a5 5 0 1 0 0 10 5 5 0 0 0 0-10Zm0 0V19" }, null, -1)];
  ...
  const Bh = Object.assign(xh, { install: (e2, t2) => {
    var _a2;
    const n2 = (_a2 = t2 == null ? void 0 : t2.iconPrefix) != null ? _a2 : "";
    e2.component(n2 + xh.name, xh);
  } }), Ch = e.defineComponent({ name: "IconDesktop", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-desktop`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Nh = ["stroke-width", "stroke-linecap", "stroke-linejoin"], $h = [e.createElementVNode("path", { d: "M24 32v8m0 0h-9m9 0h9M7 32h34a1 1 0 0 0 1-1V9a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1v22a1 1 0 0 0 1 1Z" }, null, -1)];
  var Eh = r(Ch, [["render", function(t2, n2, o2, i2, r2, s2) {
  ...
  const Ah = Object.assign(Fh, { install: (e2, t2) => {
    ...
    const n2 = (_a2 = t2 == null ? void 0 : t2.iconPrefix) != null ? _a2 : "";
    e2.component(n2 + Fh.name, Fh);
  } }), Dh = e.defineComponent({ name: "IconDragDot", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-drag-dot`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Rh = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Th = [e.createElementVNode("path", { d: "M40 17v2h-2v-2h2ZM25 17v2h-2v-2h2ZM10 17v2H8v-2h2ZM40 29v2h-2v-2h2ZM25 29v2h-2v-2h2ZM10 29v2H8v-2h2Z", fill: "currentColor", stroke: "none" }, null, -1), e.createElementVNode("path", { d: "M40 17v2h-2v-2h2ZM25 17v2h-2v-2h2ZM10 17v2H8v-2h2ZM40 29v2h-2v-2h2ZM25 29v2h-2v-2h2ZM10 29v2H8v-2h2Z" }, null, -1)];
  ...
  const Qh = Object.assign(Uh, { install: (e2, t2) => {
    ...
    const n2 = (_a2 = t2 == null ? void 0 : t2.iconPrefix) != null ? _a2 : "";
    e2.component(n2 + Uh.name, Uh);
  } }), Gh = e.defineComponent({ name: "IconDriveFile", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-drive-file`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Xh = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Jh = [e.createElementVNode("path", { d: "M38.5 17H29a1 1 0 0 1-1-1V6.5m0-.5H10a1 1 0 0 0-1 1v34a1 1 0 0 0 1 1h28a1 1 0 0 0 1-1V17L28 6Z" }, null, -1)];
  var Kh = r(Gh, [["render", function(t2, n2, o2, i2, r2, s2) {
    return e.openBlock(), e.createElementBlock("svg", { viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg", stroke: "currentColor", class: e.normalizeClass(t2.cls), style: e.normalizeStyle(t2.sizeStyle), "stroke-width": t2.strokeWidth, "stroke-linecap": t2.strokeLinecap, "stroke-linejoin": t2.strokeLinejoin }, Jh, 14, Xh);
  }]]);
  const Yh = Object.assign(Kh, { install: (e2, t2) => {
    var _a2;
    const n2 = (_a2 = t2 == null ? void 0 : t2.iconPrefix) != null ? _a2 : "";
    e2.component(n2 + Kh.name, Kh);
  } }), _h = e.defineComponent({ name: "IconEar", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-ear`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), ey = ["stroke-width", "stroke-linecap", "stroke-linejoin"], ty = [e.createElementVNode("path", { d: "M13 15.528C14.32 12.386 18.403 6.977 23.556 7c7.944.036 14.514 8.528 10.116 15.71-4.399 7.181-5.718 10.323-6.598 14.363-.82 3.766-9.288 7.143-11.498-1.515M20 18.5c1-3.083 4.5-4.5 6.5-2 2.85 3.562-3.503 8.312-5.5 12.5" }, null, -1)];
  ...
  } }), iy = e.defineComponent({ name: "IconEmail", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-email`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), ry = ["stroke-width", "stroke-linecap", "stroke-linejoin"], sy = [e.createElementVNode("rect", { x: "6", y: "8", width: "36", height: "32", rx: "1" }, null, -1), e.createElementVNode("path", { d: "m37 17-12.43 8.606a1 1 0 0 1-1.14 0L11 17" }, null, -1)];
  ...
  } }), ay = e.defineComponent({ name: "IconEmpty", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-empty`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), py = ["stroke-width", "stroke-linecap", "stroke-linejoin"], uy = [e.createElementVNode("path", { d: "M24 5v6m7 1 4-4m-18 4-4-4m28.5 22H28s-1 3-4 3-4-3-4-3H6.5M40 41H8a2 2 0 0 1-2-2v-8.46a2 2 0 0 1 .272-1.007l6.15-10.54A2 2 0 0 1 14.148 18H33.85a2 2 0 0 1 1.728.992l6.149 10.541A2 2 0 0 1 42 30.541V39a2 2 0 0 1-2 2Z" }, null, -1)];
  ...
  } }), ky = e.defineComponent({ name: "IconExperiment", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-experiment`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), zy = ["stroke-width", "stroke-linecap", "stroke-linejoin"], fy = [e.createElementVNode("path", { d: "M10.5 7h6m0 0v10.5l-5.25 14M16.5 7h15m0 0h6m-6 0v10.5L37 32.167M11.25 31.5l-2.344 6.853A2 2 0 0 0 10.8 41h26.758a2 2 0 0 0 1.86-2.737L37 32.167M11.25 31.5c1.916 1.833 7.05 4.4 12.25 0s11.166-1.389 13.5.667M26 22.5v.01" }, null, -1)];
  ...
  } }), yy = e.defineComponent({ name: "IconFileAudio", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-file-audio`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), gy = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Sy = [e.createElementVNode("path", { d: "M37 42H11a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h21l7 7v27a2 2 0 0 1-2 2Z" }, null, -1), e.createElementVNode("path", { d: "M25 30a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z", fill: "currentColor", stroke: "none" }, null, -1), e.createElementVNode("path", { d: "M25 30a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm0 0-.951-12.363a.5.5 0 0 1 .58-.532L30 18" }, null, -1)];
  ...
  } }), jy = e.defineComponent({ name: "IconFileImage", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-file-image`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Ly = ["stroke-width", "stroke-linecap", "stroke-linejoin"], xy = [e.createElementVNode("path", { d: "m26 33 5-6v6h-5Zm0 0-3-4-4 4h7Zm11 9H11a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h21l7 7v27a2 2 0 0 1-2 2ZM17 19h1v1h-1v-1Z" }, null, -1)];
  var By = r(jy, [["render", function(t2, n2, o2, i2, r2, s2) {
  ...
  } }), Wy = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Zy = [e.createElementVNode("path", { d: "M37 42H11a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h21l7 7v27a2 2 0 0 1-2 2Z" }, null, -1), e.createElementVNode("path", { d: "M22 27.796v-6l5 3-5 3Z" }, null, -1)];
  ...
  } }), Oy = e.defineComponent({ name: "IconFile", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-file`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Hy = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Fy = [e.createElementVNode("path", { d: "M16 21h16m-16 8h10m11 13H11a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h21l7 7v27a2 2 0 0 1-2 2Z" }, null, -1)];
  ...
  } }), Xy = e.defineComponent({ name: "IconFolderAdd", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-folder-add`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Jy = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Ky = [e.createElementVNode("path", { d: "M24 19v14m-7-7h14M6 13h18l-2.527-3.557a1.077 1.077 0 0 0-.88-.443H7.06C6.474 9 6 9.448 6 10v3Zm0 0h33.882c1.17 0 2.118.895 2.118 2v21c0 1.105-.948 3-2.118 3H8.118C6.948 39 6 38.105 6 37V13Z" }, null, -1)];
  ...
  } }), eg = e.defineComponent({ name: "IconFolderDelete", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-folder-delete`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), tg = ["stroke-width", "stroke-linecap", "stroke-linejoin"], ng = [e.createElementVNode("path", { d: "M17 26h14M6 13h18l-2.527-3.557a1.077 1.077 0 0 0-.88-.443H7.06C6.474 9 6 9.448 6 10v3Zm0 0h33.882c1.17 0 2.118.895 2.118 2v21c0 1.105-.948 3-2.118 3H8.118C6.948 39 6 38.105 6 37V13Z" }, null, -1)];
  ...
  } }), rg = e.defineComponent({ name: "IconFolder", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-folder`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), sg = ["stroke-width", "stroke-linecap", "stroke-linejoin"], lg = [e.createElementVNode("path", { d: "M6 13h18l-2.527-3.557a1.077 1.077 0 0 0-.88-.443H7.06C6.474 9 6 9.448 6 10v3Zm0 0h33.882c1.17 0 2.118.895 2.118 2v21c0 1.105-.948 3-2.118 3H8.118C6.948 39 6 38.105 6 37V13Z" }, null, -1)];
  ...
  } }), zg = e.defineComponent({ name: "IconIdcard", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-idcard`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), fg = ["stroke-width", "stroke-linecap", "stroke-linejoin"], vg = [e.createElementVNode("path", { d: "M11 17h9m-9 7h9m-9 7h5m-8 9h32a2 2 0 0 0 2-2V10a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v28a2 2 0 0 0 2 2Z" }, null, -1), e.createElementVNode("path", { d: "M36 33a7 7 0 1 0-14 0" }, null, -1), e.createElementVNode("circle", { cx: "29", cy: "20", r: "4" }, null, -1)];
  ...
  } }), Lg = e.defineComponent({ name: "IconImage", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-image`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), xg = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Bg = [e.createElementVNode("path", { d: "m24 33 9-9v9h-9Zm0 0-3.5-4.5L17 33h7Zm15 8H9a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2h30a2 2 0 0 1 2 2v30a2 2 0 0 1-2 2ZM15 15h2v2h-2v-2Z" }, null, -1), e.createElementVNode("path", { d: "M33 33v-9l-9 9h9ZM23.5 33l-3-4-3 4h6ZM15 15h2v2h-2z", fill: "currentColor", stroke: "none" }, null, -1)];
  var Cg = r(Lg, [["render", function(t2, n2, o2, i2, r2, s2) {
    return e.openBlock(), e.createElementBlock("svg", { viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg", stroke: "currentColor", class: e.normalizeClass(t2.cls), style: e.normalizeStyle(t2.sizeStyle), "stroke-width": t2.strokeWidth, "stroke-linecap": t2.strokeLinecap, "stroke-linejoin": t2.strokeLinejoin }, Bg, 14, xg);
  }]]);
  const Ng = Object.assign(Cg, { install: (e2, t2) => {
    var _a2;
    const n2 = (_a2 = t2 == null ? void 0 : t2.iconPrefix) != null ? _a2 : "";
    e2.component(n2 + Cg.name, Cg);
  } }), $g = e.defineComponent({ name: "IconInteraction", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-interaction`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Eg = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Mg = [e.createElementVNode("path", { d: "M8 19h16m16 0H24m0 0v23m14 0H10a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h28a2 2 0 0 1 2 2v32a2 2 0 0 1-2 2Z" }, null, -1)];
  ...
  } }), Hg = e.defineComponent({ name: "IconLayout", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-layout`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Fg = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Ag = [e.createElementVNode("path", { d: "M19 40V8m23 2a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v28a2 2 0 0 0 2 2h32a2 2 0 0 0 2-2V10Z" }, null, -1)];
  ...
  } }), Tg = e.defineComponent({ name: "IconLoading", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-loading`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Ug = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Qg = [e.createElementVNode("path", { d: "M42 24c0 9.941-8.059 18-18 18S6 33.941 6 24 14.059 6 24 6" }, null, -1)];
  ...
  } }), Jg = e.defineComponent({ name: "IconLocation", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-location`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Kg = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Yg = [e.createElementVNode("circle", { cx: "24", cy: "19", r: "5" }, null, -1), e.createElementVNode("path", { d: "M39 20.405C39 28.914 24 43 24 43S9 28.914 9 20.405C9 11.897 15.716 5 24 5c8.284 0 15 6.897 15 15.405Z" }, null, -1)];
  ...
  } }), tS = e.defineComponent({ name: "IconLock", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-lock`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), nS = ["stroke-width", "stroke-linecap", "stroke-linejoin"], oS = [e.createElementVNode("path", { d: "M9 41.5h30a2 2 0 0 0 2-2v-20a2 2 0 0 0-2-2H9a2 2 0 0 0-2 2v20a2 2 0 0 0 2 2ZM16 14.5a8 8 0 1 1 16 0v3H16v-3Z" }, null, -1), e.createElementVNode("path", { d: "M28 29.5a4 4 0 1 1-8 0 4 4 0 0 1 8 0Z" }, null, -1)];
  ...
  } }), sS = e.defineComponent({ name: "IconLoop", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-loop`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), lS = ["stroke-width", "stroke-linecap", "stroke-linejoin"], cS = [e.createElementVNode("path", { d: "M24 38c-7.732 0-14-6.268-14-14 0-3.815 1.526-7.273 4-9.798M24 10c7.732 0 14 6.268 14 14 0 3.815-1.526 7.273-4 9.798M24 7v6l-4-3 4-3Zm0 33v-6l4 3-4 3Z" }, null, -1)];
  ...
  } }), uS = e.defineComponent({ name: "IconMan", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-man`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), dS = ["stroke-width", "stroke-linecap", "stroke-linejoin"], mS = [e.createElementVNode("path", { d: "M40 8 29.68 18.321M31 8h9v9m-7 10c0 7.18-5.82 13-13 13S7 34.18 7 27s5.82-13 13-13 13 5.82 13 13Z" }, null, -1)];
  ...
  } }), fS = e.defineComponent({ name: "IconMenu", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-menu`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), vS = ["stroke-width", "stroke-linecap", "stroke-linejoin"], hS = [e.createElementVNode("path", { d: "M5 10h38M5 24h38M5 38h38" }, null, -1)];
  ...
  } }), wS = ["stroke-width", "stroke-linecap", "stroke-linejoin"], bS = [e.createElementVNode("path", { d: "M20 10h23M20 24h23M20 38h23M9 12v28m0-28a2 2 0 1 0 0-4 2 2 0 0 0 0 4Zm0 26h7M9 24h7" }, null, -1)];
  var jS = r(SS, [["render", function(t2, n2, o2, i2, r2, s2) {
    return e.openBlock(), e.createElementBlock("svg", { viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg", stroke: "currentColor", class: e.normalizeClass(t2.cls), style: e.normalizeStyle(t2.sizeStyle), "stroke-width": t2.strokeWidth, "stroke-linecap": t2.strokeLinecap, "stroke-linejoin": t2.strokeLinejoin }, bS, 14, wS);
  }]]);
  const LS = Object.assign(jS, { install: (e2, t2) => {
    var _a2;
    const n2 = (_a2 = t2 == null ? void 0 : t2.iconPrefix) != null ? _a2 : "";
    e2.component(n2 + jS.name, jS);
  } }), xS = e.defineComponent({ name: "IconMobile", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-mobile`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), BS = ["stroke-width", "stroke-linecap", "stroke-linejoin"], CS = [e.createElementVNode("path", { d: "M17 14h14m6.125 28h-26.25C9.839 42 9 41.105 9 40V8c0-1.105.84-2 1.875-2h26.25C38.16 6 39 6.895 39 8v32c0 1.105-.84 2-1.875 2ZM22 33a2 2 0 1 1 4 0 2 2 0 0 1-4 0Z" }, null, -1), e.createElementVNode("circle", { cx: "24", cy: "33", r: "2", fill: "currentColor", stroke: "none" }, null, -1)];
  var NS = r(xS, [["render", function(t2, n2, o2, i2, r2, s2) {
    return e.openBlock(), e.createElementBlock("svg", { viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg", stroke: "currentColor", class: e.normalizeClass(t2.cls), style: e.normalizeStyle(t2.sizeStyle), "stroke-width": t2.strokeWidth, "stroke-linecap": t2.strokeLinecap, "stroke-linejoin": t2.strokeLinejoin }, CS, 14, BS);
  }]]);
  const $S = Object.assign(NS, { install: (e2, t2) => {
    var _a2;
    const n2 = (_a2 = t2 == null ? void 0 : t2.iconPrefix) != null ? _a2 : "";
    e2.component(n2 + NS.name, NS);
  } }), ES = e.defineComponent({ name: "IconMoon", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-moon`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), MS = ["stroke-width", "stroke-linecap", "stroke-linejoin"], VS = [e.createElementVNode("path", { d: "M39.979 29.241c.11-.344-.23-.654-.574-.544-1.53.487-3.162.75-4.855.75-8.834 0-15.997-7.163-15.997-15.997 0-1.693.263-3.324.75-4.855.11-.344-.2-.684-.544-.574C11.939 10.19 7 16.576 7 24.114 7 33.44 14.56 41 23.886 41c7.538 0 13.923-4.94 16.093-11.759Z" }, null, -1)];
  ...
  const HS = Object.assign(OS, { install: (e2, t2) => {
    ...
    const n2 = (_a2 = t2 == null ? void 0 : t2.iconPrefix) != null ? _a2 : "";
    e2.component(n2 + OS.name, OS);
  } }), FS = e.defineComponent({ name: "IconNav", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-nav`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), AS = ["stroke-width", "stroke-linecap", "stroke-linejoin"], DS = [e.createElementVNode("path", { d: "M6 19h10m0 0h26m-26 0V9m0 10v10m0 0v10m0-10H6m10 0h26M6 9h36v30H6V9Z" }, null, -1)];
  ...
  } }), US = e.defineComponent({ name: "IconNotificationClose", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-notification-close`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), QS = ["stroke-width", "stroke-linecap", "stroke-linejoin"], GS = [e.createElementVNode("path", { d: "M11 35V22c0-1.835.38-3.58 1.066-5.163M11 35H6m5 0h15.5M24 9c7.18 0 13 5.82 13 13v7.5M24 9V4m0 5a12.94 12.94 0 0 0-6.5 1.74M17 42h14M6 4l36 40" }, null, -1)];
  ...
  } }), KS = e.defineComponent({ name: "IconNotification", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-notification`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), YS = ["stroke-width", "stroke-linecap", "stroke-linejoin"], _S = [e.createElementVNode("path", { d: "M24 9c7.18 0 13 5.82 13 13v13H11V22c0-7.18 5.82-13 13-13Zm0 0V4M6 35h36m-25 7h14" }, null, -1)];
  ...
  } }), nw = e.defineComponent({ name: "IconPen", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-pen`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), ow = ["stroke-width", "stroke-linecap", "stroke-linejoin"], iw = [e.createElementVNode("path", { d: "m28.364 11.565 7.07 7.071M7.15 32.778 33.313 6.615l7.071 7.071L14.221 39.85h-7.07v-7.07Z" }, null, -1)];
  ...
  } }), dw = e.defineComponent({ name: "IconPrinter", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-printer`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), mw = ["stroke-width", "stroke-linecap", "stroke-linejoin"], kw = [e.createElementVNode("path", { d: "M14 15V8a1 1 0 0 1 1-1h18a1 1 0 0 1 1 1v7m-20 0H7a1 1 0 0 0-1 1v17a1 1 0 0 0 1 1h6m1-19h20m0 0h7a1 1 0 0 1 1 1v17a1 1 0 0 1-1 1h-6m-22 0v6a1 1 0 0 0 1 1h20a1 1 0 0 0 1-1v-6m-22 0v-5a1 1 0 0 1 1-1h20a1 1 0 0 1 1 1v5" }, null, -1)];
  ...
  } }), ww = e.defineComponent({ name: "IconPushpin", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-pushpin`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), bw = ["stroke-width", "stroke-linecap", "stroke-linejoin"], jw = [e.createElementVNode("path", { d: "M19.921 28.163 7.193 40.89m12.728-12.728 8.884 8.883c.17.17.447.17.617 0l5.12-5.12a7.862 7.862 0 0 0 1.667-8.655.093.093 0 0 1 .02-.102l4.906-4.906a2 2 0 0 0 0-2.828L32.648 6.95a2 2 0 0 0-2.828 0l-4.89 4.889a.126.126 0 0 1-.139.027 7.828 7.828 0 0 0-8.618 1.66l-5.027 5.026a.591.591 0 0 0 0 .836l8.774 8.775Z" }, null, -1)];
  ...
  } }), Bw = e.defineComponent({ name: "IconQrcode", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-qrcode`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Cw = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Nw = [e.createElementVNode("path", { d: "M24 30v4m0 3v6m19-19h-6m-3 0h-4M7 7h17v17H7V7Zm0 25h9v9H7v-9Zm25 0h9v9h-9v-9Zm0-25h9v9h-9V7Zm-18 7h3v3h-3v-3Z" }, null, -1)];
  var $w = r(Bw, [["render", function(t2, n2, o2, i2, r2, s2) {
    return e.openBlock(), e.createElementBlock("svg", { viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg", stroke: "currentColor", class: e.normalizeClass(t2.cls), style: e.normalizeStyle(t2.sizeStyle), "stroke-width": t2.strokeWidth, "stroke-linecap": t2.strokeLinecap, "stroke-linejoin": t2.strokeLinejoin }, Nw, 14, Cw);
  }]]);
  const Ew = Object.assign($w, { install: (e2, t2) => {
    var _a2;
    const n2 = (_a2 = t2 == null ? void 0 : t2.iconPrefix) != null ? _a2 : "";
    e2.component(n2 + $w.name, $w);
  } }), Mw = e.defineComponent({ name: "IconRobotAdd", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-robot-add`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Vw = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Iw = [e.createElementVNode("path", { d: "M24 7v6m0-6h5m-5 0h-5M3 21v11m25 8H9V13h30v11m-7 11h14m-7-7v14M18 26h1v1h-1v-1Zm11 0h1v1h-1v-1Z" }, null, -1)];
  ...
  } }), Pw = e.defineComponent({ name: "IconRobot", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-robot`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), qw = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Ow = [e.createElementVNode("path", { d: "M18 26h1v1h-1v-1ZM29 26h1v1h-1v-1Z", fill: "currentColor", stroke: "none" }, null, -1), e.createElementVNode("path", { d: "M24 7v6m0-6h5m-5 0h-5M3 21v11m36 8H9V13h30v29m6-21v11m-27-6h1v1h-1v-1Zm11 0h1v1h-1v-1Z" }, null, -1)];
  ...
  } }), Aw = e.defineComponent({ name: "IconSafe", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-safe`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Dw = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Rw = [e.createElementVNode("path", { d: "m16.825 22.165 6 6 10-10M24 6c7 4 16 5 16 5v15s-2 12-16 16.027C10 38 8 26 8 26V11s9-1 16-5Z" }, null, -1)];
  ...
  } }), Qw = e.defineComponent({ name: "IconSchedule", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-schedule`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Gw = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Xw = [e.createElementVNode("circle", { cx: "24", cy: "24", r: "18" }, null, -1), e.createElementVNode("path", { d: "M24 13v10l6.5 7" }, null, -1)];
  ...
  } }), ob = e.defineComponent({ name: "IconSkin", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-skin`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), ib = ["stroke-width", "stroke-linecap", "stroke-linejoin"], rb = [e.createElementVNode("path", { d: "M17.936 6H7a1 1 0 0 0-1 1v17.559a1 1 0 0 0 1 1h4V40a1 1 0 0 0 1 1h24a1 1 0 0 0 1-1V25.559h4a1 1 0 0 0 1-1V7a1 1 0 0 0-1-1H30.064C28.854 7.23 26.59 9.059 24 9.059S19.147 7.23 17.936 6Z" }, null, -1)];
  ...
  } }), cb = e.defineComponent({ name: "IconStamp", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-stamp`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), ab = ["stroke-width", "stroke-linecap", "stroke-linejoin"], pb = [e.createElementVNode("path", { d: "M7 33a1 1 0 0 1 1-1h32a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1H8a1 1 0 0 1-1-1v-7ZM29.081 21.18a8 8 0 1 0-10.163 0L14 32h20l-4.919-10.82Z" }, null, -1)];
  ...
  } }), hb = e.defineComponent({ name: "IconSubscribeAdd", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-subscribe-add`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), yb = ["stroke-width", "stroke-linecap", "stroke-linejoin"], gb = [e.createElementVNode("path", { d: "M24.53 6.007H9.97c-.535 0-.97.449-.97 1.003V41.8c0 .148.152.245.28.179l15.25-7.881 14.248 7.88c.129.067.28-.03.28-.179V22.06M27.413 11.023h6.794m0 0H41m-6.794 0V4m0 7.023v7.023" }, null, -1)];
  ...
  const wb = Object.assign(Sb, { install: (e2, t2) => {
    ...
    const n2 = (_a2 = t2 == null ? void 0 : t2.iconPrefix) != null ? _a2 : "";
    e2.component(n2 + Sb.name, Sb);
  } }), bb = e.defineComponent({ name: "IconSubscribe", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-subscribe`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), jb = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Lb = [e.createElementVNode("path", { d: "M9 7v34.667a.2.2 0 0 0 .294.176L24 34l14.706 7.843a.2.2 0 0 0 .294-.176V7a1 1 0 0 0-1-1H10a1 1 0 0 0-1 1Z" }, null, -1)];
  var xb = r(bb, [["render", function(t2, n2, o2, i2, r2, s2) {
    return e.openBlock(), e.createElementBlock("svg", { viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg", stroke: "currentColor", class: e.normalizeClass(t2.cls), style: e.normalizeStyle(t2.sizeStyle), "stroke-width": t2.strokeWidth, "stroke-linecap": t2.strokeLinecap, "stroke-linejoin": t2.strokeLinejoin }, Lb, 14, jb);
  }]]);
  const Bb = Object.assign(xb, { install: (e2, t2) => {
    var _a2;
    const n2 = (_a2 = t2 == null ? void 0 : t2.iconPrefix) != null ? _a2 : "";
    e2.component(n2 + xb.name, xb);
  } }), Cb = e.defineComponent({ name: "IconSubscribed", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-subscribed`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Nb = ["stroke-width", "stroke-linecap", "stroke-linejoin"], $b = [e.createElementVNode("path", { d: "m31.289 15.596-9.193 9.193-4.95-4.95M24 34l14.706 7.843a.2.2 0 0 0 .294-.176V7a1 1 0 0 0-1-1H10a1 1 0 0 0-1 1v34.667a.2.2 0 0 0 .294.176L24 34Z" }, null, -1)];
  var Eb = r(Cb, [["render", function(t2, n2, o2, i2, r2, s2) {
  ...
  } }), Vb = e.defineComponent({ name: "IconSun", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
  ...
  } }), qb = e.defineComponent({ name: "IconTag", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-tag`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Ob = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Hb = [e.createElementVNode("path", { d: "M24.835 6.035a1 1 0 0 1 .903-.273l12.964 2.592a1 1 0 0 1 .784.785l2.593 12.963a1 1 0 0 1-.274.904L21.678 43.133a1 1 0 0 1-1.415 0L4.708 27.577a1 1 0 0 1 0-1.414L24.835 6.035Z" }, null, -1), e.createElementVNode("path", { d: "M31.577 17.346a1 1 0 1 1 0-2 1 1 0 0 1 0 2Z" }, null, -1), e.createElementVNode("path", { d: "M31.582 17.349a1 1 0 1 1 0-2 1 1 0 0 1 0 2Z", fill: "currentColor", stroke: "none" }, null, -1)];
  ...
  const Qb = Object.assign(Ub, { install: (e2, t2) => {
    ...
    const n2 = (_a2 = t2 == null ? void 0 : t2.iconPrefix) != null ? _a2 : "";
    e2.component(n2 + Ub.name, Ub);
  } }), Gb = e.defineComponent({ name: "IconThunderbolt", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-thunderbolt`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Xb = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Jb = [e.createElementVNode("path", { d: "M27.824 5.203A.1.1 0 0 1 28 5.27V21h10.782a.1.1 0 0 1 .075.165L20.176 42.797A.1.1 0 0 1 20 42.73V27H9.219a.1.1 0 0 1-.076-.165L27.824 5.203Z" }, null, -1)];
  ...
  } }), _b = e.defineComponent({ name: "IconTool", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-tool`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), ej = ["stroke-width", "stroke-linecap", "stroke-linejoin"], tj = [e.createElementVNode("path", { d: "M19.994 11.035c3.66-3.659 9.094-4.46 13.531-2.405a.1.1 0 0 1 .028.16l-6.488 6.488a1 1 0 0 0 0 1.414l4.243 4.243a1 1 0 0 0 1.414 0l6.488-6.488a.1.1 0 0 1 .16.028c2.056 4.437 1.254 9.872-2.405 13.53-3.695 3.696-9.2 4.477-13.66 2.347L12.923 40.733a1 1 0 0 1-1.414 0L7.266 36.49a1 1 0 0 1 0-1.414l10.382-10.382c-2.13-4.46-1.349-9.965 2.346-13.66Z" }, null, -1)];
  ...
  } }), ij = e.defineComponent({ name: "IconTrophy", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-trophy`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), rj = ["stroke-width", "stroke-linecap", "stroke-linejoin"], sj = [e.createElementVNode("path", { d: "M24 33c-6.075 0-11-4.925-11-11m11 11c6.075 0 11-4.925 11-11M24 33v8M13 22V7h22v15m-22 0V9H7v7a6 6 0 0 0 6 6Zm22 0V9h6v7a6 6 0 0 1-6 6ZM12 41h24" }, null, -1)];
  ...
  } }), aj = e.defineComponent({ name: "IconUnlock", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-unlock`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), pj = ["stroke-width", "stroke-linecap", "stroke-linejoin"], uj = [e.createElementVNode("rect", { x: "7", y: "21", width: "34", height: "20", rx: "1" }, null, -1), e.createElementVNode("path", { d: "M33 15a9 9 0 1 0-18 0v6M24 36V26" }, null, -1)];
  ...
  } }), kj = e.defineComponent({ name: "IconUserAdd", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-user-add`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), zj = ["stroke-width", "stroke-linecap", "stroke-linejoin"], fj = [e.createElementVNode("path", { d: "M25 27h-8c-5.523 0-10 4.477-10 10v4h18m11-14v8m0 0v8m0-8h8m-8 0h-8m3-21a7 7 0 1 1-14 0 7 7 0 0 1 14 0Z" }, null, -1)];
  ...
  } }), yj = e.defineComponent({ name: "IconUserGroup", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-user-group`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), gj = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Sj = [e.createElementVNode("circle", { cx: "18", cy: "15", r: "7" }, null, -1), e.createElementVNode("circle", { cx: "34", cy: "19", r: "4" }, null, -1), e.createElementVNode("path", { d: "M6 34a6 6 0 0 1 6-6h12a6 6 0 0 1 6 6v6H6v-6ZM34 30h4a4 4 0 0 1 4 4v4h-8" }, null, -1)];
  ...
  } }), jj = e.defineComponent({ name: "IconUser", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-user`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Lj = ["stroke-width", "stroke-linecap", "stroke-linejoin"], xj = [e.createElementVNode("path", { d: "M7 37c0-4.97 4.03-8 9-8h16c4.97 0 9 3.03 9 8v3a1 1 0 0 1-1 1H8a1 1 0 0 1-1-1v-3Z" }, null, -1), e.createElementVNode("circle", { cx: "24", cy: "15", r: "8" }, null, -1)];
  var Bj = r(jj, [["render", function(t2, n2, o2, i2, r2, s2) {
  ...
  const Cj = Object.assign(Bj, { install: (e2, t2) => {
    var _a2;
    const n2 = (_a2 = t2 == null ? void 0 : t2.iconPrefix) != null ? _a2 : "";
    e2.component(n2 + Bj.name, Bj);
  } }), Nj = e.defineComponent({ name: "IconVideoCamera", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-video-camera`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), $j = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Ej = [e.createElementVNode("path", { d: "M33 18v12m0-12v-6a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1v24a1 1 0 0 0 1 1h25a1 1 0 0 0 1-1v-6m0-12 8.713-2.614a1 1 0 0 1 1.287.958v15.312a1 1 0 0 1-1.287.958L33 30M11 19h6" }, null, -1)];
  ...
  } }), Oj = e.defineComponent({ name: "IconWoman", props: { size: { type: [Number, String] }, strokeWidth: { type: Number, default: 4 }, strokeLinecap: { type: String, default: "butt", validator: (e2) => ["butt", "round", "square"].includes(e2) }, strokeLinejoin: { type: String, default: "miter", validator: (e2) => ["arcs", "bevel", "miter", "miter-clip", "round"].includes(e2) }, spin: Boolean }, setup(t2) {
    const o2 = n("icon");
    return { cls: e.computed(() => [o2, `${o2}-woman`, { [`${o2}-spin`]: t2.spin }]), sizeStyle: e.computed(() => {
      if (t2.size)
        return { fontSize: i(t2.size) ? `${t2.size}px` : t2.size };
    }) };
  } }), Hj = ["stroke-width", "stroke-linecap", "stroke-linejoin"], Fj = [e.createElementVNode("path", { d: "M24 29c6.075 0 11-4.925 11-11S30.075 7 24 7s-11 4.925-11 11 4.925 11 11 11Zm0 0v15M15 36h18" }, null, -1)];
  ...
  const Dj = { IconArrowDown: p, IconArrowFall: z, IconArrowLeft: g, IconArrowRight: L, IconArrowRise: $, IconArrowUp: W, IconCaretDown: H, IconCaretLeft: T, IconCaretRight: J, IconCaretUp: te, IconDoubleDown: se, IconDoubleLeft: ue, IconDoubleRight: fe, IconDoubleUp: Se, IconDownCircle: xe, IconDown: Ee, IconDragArrow: Ze, IconExpand: Fe, IconLeftCircle: Ue, IconLeft: Ke, IconMenuFold: nt, IconMenuUnfold: lt, IconRightCircle: dt, IconRight: vt, IconRotateLeft: wt, IconRotateRight: Bt, IconShrink: Mt, IconSwap: Pt, IconToBottom: At, IconToLeft: Qt, IconToRight: Yt, IconToTop: on, IconUpCircle: an, IconUp: kn, IconCheckCircleFill: yn, IconCloseCircleFill: jn, IconExclamationCircleFill: Nn, IconExclamationPolygonFill: In, IconInfoCircleFill: On, IconMinusCircleFill: Rn, IconPlusCircleFill: Xn, IconQuestionCircleFill: eo, IconCheckCircle: ro, IconCheckSquare: po, IconCheck: fo, IconClockCircle: So, IconCloseCircle: xo, IconClose: Eo, IconExclamationCircle: Zo, IconExclamation: Fo, IconInfoCircle: Uo, IconInfo: Ko, IconMinusCircle: ni, IconMinus: li, IconPlusCircle: di, IconPlus: vi, IconQuestionCircle: wi, IconQuestion: Bi, IconStop: Mi, IconHeartFill: Pi, IconStarFill: Ai, IconThumbDownFill: Qi, IconThumbUpFill: Yi, IconAt: or, IconCloudDownload: cr, IconCodeBlock: mr, IconCodeSquare: hr, IconCode: br, IconCustomerService: Cr, IconDownload: Vr, IconExport: qr, IconEyeInvisible: Dr, IconEye: Gr, IconHeart: _r, IconHistory: is, IconHome: as, IconImport: ks, IconList: ys, IconMessageBanned: js, IconMessage: Ns, IconMoreVertical: Is, IconMore: Os, IconPoweroff: Rs, IconRefresh: Xs, IconReply: el, IconSave: rl, IconScan: pl, IconSearch: zl, IconSelectAll: gl, IconSend: Ll, IconSettings: $l, IconShareAlt: Wl, IconShareExternal: Hl, IconShareInternal: Tl, IconStar: Jl, IconSync: tc, IconThumbDown: sc, IconThumbUp: uc, IconTranslate: fc, IconUpload: Sc, IconVoice: xc, IconAlignCenter: Ec, IconAlignLeft: Zc, IconAlignRight: Fc, IconBgColors: Uc, IconBold: Kc, IconBrush: na, IconCopy: la, IconDelete: da, IconEdit: va, IconEraser: wa, IconFilter: Ba, IconFindReplace: Ma, IconFontColors: Pa, IconFormula: Aa, IconH1: Qa, IconH2: Ya, IconH3: op, IconH4: cp, IconH5: mp, IconH6: hp, IconH7: bp, IconHighlight: Cp, IconItalic: Vp, IconLineHeight: qp, IconLink: Dp, IconObliqueLine: Gp, IconOrderedList: _p, IconOriginalSize: iu, IconPaste: au, IconQuote: ku, IconRedo: yu, IconScissor: ju, IconSortAscending: Nu, IconSortDescending: Iu, IconSort: Ou, IconStrikethrough: Ru, IconUnderline: Xu, IconUndo: ed, IconUnorderedList: rd, IconZoomIn: pd, IconZoomOut: zd, IconMuteFill: gd, IconPauseCircleFill: Ld, IconPlayArrowFill: $d, IconPlayCircleFill: Wd, IconSkipNextFill: Hd, IconSkipPreviousFill: Td, IconSoundFill: Jd, IconBackward: tm, IconForward: sm, IconFullscreenExit: um, IconFullscreen: fm, IconLiveBroadcast: Sm, IconMusic: xm, IconMute: Em, IconPauseCircle: Zm, IconPause: Fm, IconPlayArrow: Um, IconPlayCircle: Km, IconRecordStop: nk, IconRecord: lk, IconSkipNext: dk, IconSkipPrevious: vk, IconSound: wk, IconBytedanceColor: Bk, IconLarkColor: Mk, IconTiktokColor: Pk, IconXiguaColor: Ak, IconFaceBookCircleFill: Qk, IconFacebookSquareFill: Yk, IconGoogleCircleFill: oz, IconQqCircleFill: cz, IconTwitterCircleFill: mz, IconWeiboCircleFill: hz, IconAlipayCircle: bz, IconCodeSandbox: Cz, IconCodepen: Vz, IconFacebook: qz, IconGithub: Dz, IconGitlab: Gz, IconGoogle: _z, IconQqZone: rf, IconQq: pf, IconTwitter: zf, IconWechat: gf, IconWechatpay: Lf, IconWeibo: $f, IconChineseFill: Wf, IconEnglishFill: Hf, IconFaceFrownFill: Tf, IconFaceMehFill: Jf, IconFaceSmileFill: tv, IconMoonFill: sv, IconPenFill: uv, IconSunFill: fv, IconApps: Sv, IconBook: xv, IconBranch: Ev, IconBug: Zv, IconBulb: Fv, IconCalendar: Uv, IconCamera: Kv, IconCloud: nh, IconCommand: lh, IconCommon: dh, IconCompass: vh, IconCopyright: wh, IconDashboard: Bh, IconDesktop: Mh, IconDice: Ph, IconDragDotVertical: Ah, IconDragDot: Qh, IconDriveFile: Yh, IconEar: oy, IconEmail: cy, IconEmpty: my, IconExperiment: hy, IconFileAudio: by, IconFileImage: Cy, IconFilePdf: Vy, IconFileVideo: qy, IconFile: Dy, IconFire: Gy, IconFolderAdd: _y, IconFolderDelete: ig, IconFolder: ag, IconGift: kg, IconIdcard: yg, IconImageClose: jg, IconImage: Ng, IconInteraction: Ig, IconLanguage: Og, IconLayout: Rg, IconLoading: Xg, IconLocation: eS, IconLock: rS, IconLoop: pS, IconMan: zS, IconMenu: gS, IconMindMapping: LS, IconMobile: $S, IconMoon: WS, IconMosaic: HS, IconNav: TS, IconNotificationClose: JS, IconNotification: tw, IconPen: sw, IconPhone: uw, IconPrinter: fw, IconPublic: Sw, IconPushpin: xw, IconQrcode: Ew, IconRobotAdd: Zw, IconRobot: Fw, IconSafe: Uw, IconSchedule: Kw, IconShake: nb, IconSkin: lb, IconStamp: db, IconStorage: vb, IconSubscribeAdd: wb, IconSubscribe: Bb, IconSubscribed: Mb, IconSun: Pb, IconTag: Ab, IconTags: Qb, IconThunderbolt: Yb, IconTool: oj, IconTrophy: cj, IconUnlock: mj, IconUserAdd: hj, IconUserGroup: bj, IconUser: Cj, IconVideoCamera: Vj, IconWifi: qj, IconWoman: Object.assign(Aj, { install: (e2, t2) => {
    var _a2;
    const n2 = (_a2 = t2 == null ? void 0 : t2.iconPrefix) != null ? _a2 : "";
    e2.component(n2 + Aj.name, Aj);
  } }) };
  return __spreadProps(__spreadValues({}, Dj), { install: (e2, t2) => {
    for (const n2 of Object.keys(Dj))
      e2.use(Dj[n2], t2);
  } });
});
